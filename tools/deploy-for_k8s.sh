...
ContrailDir="$GOPATH/src/github.com/Juniper/contrail"
...
#[ -z "$RepoPath" ] || { mkdir -p "$GOPATH/src/github.com"; mv "$RepoPath" "$GOPATH/src/github.com/"; }
...
"${ContrailDir}/tools/testenv.sh" -n host postgres
