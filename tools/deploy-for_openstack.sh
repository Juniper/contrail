...
contrailutil convert --intype cassandra --in "$(uname -n)" -p 9041 --outtype yaml --out db_dump.yaml
...
contrailutil convert --intype yaml --in ./db_dump.yaml --outtype rdbms -c ./docker/contrail_go/etc/contrail-config_api.yml
