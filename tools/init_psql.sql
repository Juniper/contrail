...
create index contrail_controller_node_parent_uuid_index on "contrail_controller_node" ("parent_uuid");
...
create index index_contrail_controller_node_node on ref_contrail_controller_node_node ("from");
...
create index index_t_contrail_controller_node_id on tenant_share_contrail_controller_node("uuid");
create index index_t_contrail_controller_node_to on tenant_share_contrail_controller_node("to");
...
create index index_d_contrail_controller_node_id on domain_share_contrail_controller_node("uuid");
create index index_d_contrail_controller_node_to on domain_share_contrail_controller_node("to");
