...
echo "Files inside $PWD"
ls -al
echo "Files inside /go/src/github.com/Juniper/contrail/tools/patroni"
ls -al /go/src/github.com/Juniper/contrail/tools/patroni
docker-compose -f ./tools/patroni/docker-compose.yml -p "contrail" up --scale dbnode=2 -d || { echo "Files inside tools/patroni" ; ls -al ./tools/patroni ;
                                                                                               echo "Files inside patroni with abs path" ; ls -al /go/src/github.com/Juniper/contrail/tools/patroni ;
                                                                                               echo "Files inside $PWD" ; ls -al ;
                                                                                               echo "Searching for partooni file" ; find . -name patrooni.yml ;
                                                                                               exit 1 ; }
