...
$P="go/src/github.com/Juniper/contrail"
echo "Files inside $PWD" && ls -al
echo "Files inside /$P/tools/patroni" && ls -al /$P/tools/patroni
echo "Files inside $PWD/tools" && ls -al $PWD/tools
echo "Files inside /home/zuul/$P/tools" && ls -al /home/zuul/$P/tools
echo "Files inside /home/zuul/$P/tools/patroni" && ls -al /home/zuul/$P/tools/patroni
