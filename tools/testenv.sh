...
echo "Files inside dbnode /"
docker-compose -f ./tools/patroni/docker-compose.yml -p "contrail" exec -T dbnode bash -c "ls -al /" || echo "Cannot execute ls /"
echo "Files inside dbnode /psq"
docker-compose -f ./tools/patroni/docker-compose.yml -p "contrail" exec -T dbnode bash -c "ls -al /psq" || echo "Cannot execute ls /psq"
