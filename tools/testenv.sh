...
docker-compose -f ./tools/patroni/docker-compose.yml -p "contrail" exec dbnode ls -al /
docker-compose -f ./tools/patroni/docker-compose.yml -p "contrail" exec dbnode ls -al /psq
