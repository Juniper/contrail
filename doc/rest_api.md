...
| --- | --- |
| filters | Comma-separated filter parameters (e.g. 'check==a,check==b,name==Bob'; default '') [implementation broken] |
| page_limit | Limit number of returned resources (e.g. '50'; default '100' |
| page_marker | Return only the resources with UUIDs lexically greater than given value (e.g. '27e80fa2-a7d3-11e9-803e-abba7e65c022'; default '') |
...
| fields | Comma-separated list of object fields returned in response (e.g. 'name,uuid'; default  [implementation broken] |
