...
Schema command shows schema for specified resource.
	...
	contrailcli schema virtual_network -c tools/contrailcli.yml
...
Show command shows data of specified resource.
	...
	contrailcli show virtual_network first-uuid -c tools/contrailcli.yml
...
Invoke command with empty schema identifier in order to show possible usages.
	...
	contrailcli show "" "" -c tools/contrailcli.yml
...
Display them with `contrailcli list -h` command.
	...
	contrailcli list virtual_network -c tools/contrailcli.yml
...
Invoke command with empty schema identifier in order to show possible usages.
	...
	contrailcli list "" -c tools/contrailcli.yml
...
Create command creates resources defined in given YAML file.
	...
	contrailcli create pkg/cli/testdata/virtual_networks.yml -c tools/contrailcli.yml
...
Set updates properties of specified resource.
	...
	contrailcli set virtual_network first-uuid "external_ipam: true" -c tools/contrailcli.yml
...
Invoke command with empty schema identifier in order to show possible usages.
	...
	contrailcli set "" "" "" -c tools/contrailcli.yml
...
Update updates resources with data defined in given YAML file.
	...
	contrailcli update pkg/cli/testdata/virtual_networks_update.yml -c tools/contrailcli.yml
...
It creates new resource for every not already existing resource.
	...
	contrailcli sync pkg/cli/testdata/virtual_networks_update.yml -c tools/contrailcli.yml
...
Rm removes a resource with specified UUID.
	...
	contrailcli rm virtual_network second-uuid -c tools/contrailcli.yml
	
Rm command output is empty on successful operation.

Invoke command with empty schema identifier in order to show possible usages.

	contrailcli rm -c tools/contrailcli.yml
