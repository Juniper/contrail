...
$(CONTRAIL_OPENAPI_PATH): generate_go

apidoc: $(CONTRAIL_OPENAPI_PATH)
	@echo "Open http://localhost:5000 to explore the doc"
	docker run -p 5000:8080 -e SWAGGER_JSON=/$(CONTRAIL_OPENAPI_PATH) -v `pwd`/$(CONTRAIL_OPENAPI_PATH):/$(CONTRAIL_OPENAPI_PATH)/ swaggerapi/swagger-ui
