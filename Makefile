...
generate: ## Run the source code generator
	...
	rm -rf pkg/types/mocks
	mkdir pkg/types/mocks
	mockgen -destination=pkg/types/mocks/DBServiceInterface_mock.go github.com/Juniper/contrail/pkg/types DBServiceInterface
