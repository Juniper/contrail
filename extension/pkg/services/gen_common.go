// Code generated by contrailschema tool from template service_common.tmpl; DO NOT EDIT.
...
func (service *ContrailService) RegisterRESTAPI(r routeRegistry) {
	...
	r.POST("/samples", service.RESTCreateSample)
	r.GET("/samples", service.RESTListSample)
	r.PUT("/sample/:id", service.RESTUpdateSample)
	r.GET("/sample/:id", service.RESTGetSample)
	r.DELETE("/sample/:id", service.RESTDeleteSample)

	r.POST("/tags", service.RESTCreateTag)
	r.GET("/tags", service.RESTListTag)
	r.PUT("/tag/:id", service.RESTUpdateTag)
	r.GET("/tag/:id", service.RESTGetTag)
	r.DELETE("/tag/:id", service.RESTDeleteTag)
...
func getObject(ctx context.Context, rs ReadService, typeName, uuid string) (basemodels.Object, error) {
	...
	case "sample":
		resp, err := rs.GetSample(ctx, &GetSampleRequest{ID: uuid})
		return resp.GetSample(), err

	case "tag":
		resp, err := rs.GetTag(ctx, &GetTagRequest{ID: uuid})
		return resp.GetTag(), err
