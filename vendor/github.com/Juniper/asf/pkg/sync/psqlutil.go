...
// LSN is a 64 bit numeric value from Postgres.
type LSN uint64
...
// MessageLSN returns LSN from message.
...
// ParseLSN converts string to LSN.
...
type lsnCounter struct {
	// received holds max WAL LSN value received from master.
	received LSN

	// saved holds max WAL LSN value saved in etcd.
