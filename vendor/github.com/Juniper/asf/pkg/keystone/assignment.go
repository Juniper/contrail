...
func (assignment *StaticAssignment) ListUsers() (users []*User) {
...
func (assignment *StaticAssignment) ListDomains() (domains []*Domain) {
...
func (assignment *StaticAssignment) ListProjects() (projects []*Project) {
