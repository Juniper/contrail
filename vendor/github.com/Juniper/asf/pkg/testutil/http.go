...
// RequestMatcher is a regex that allows matching path given in string form.
type PathMatcher string

// Match checks if given path matches the regex.
...
// MethodMatcher is a string that compares method to it's exact value.
type MethodMatcher = stringMatcher
