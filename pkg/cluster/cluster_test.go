...
func createDummyCloudFiles(t *testing.T) func() {
	...
	err = fileutil.WriteToFile("/var/tmp/cloud/config/public_cloud_uuid/topology.yml", publicTopoData, defaultFilePermRWOnly)
	if err != nil {
	...
	err = fileutil.WriteToFile("/var/tmp/cloud/config/pvt_cloud_uuid/topology.yml", pvtTopoData, defaultFilePermRWOnly)
	if err != nil {
	...
	err = fileutil.WriteToFile("/var/tmp/cloud/config/public_cloud_uuid/secret.yml", secretData, defaultFilePermRWOnly)
	if err != nil {
