...
func (a *ansibleProvisioner) getAfxAnsibleDeployerRepoDir() (ansibleRepoDir string) {
...
func (a *ansibleProvisioner) afxplay(ansibleArgs []string) error {
	if a.cluster.config.Test {
		return a.mockPlay(ansibleArgs)
	}
	repoDir := a.getAfxAnsibleDeployerRepoDir()
