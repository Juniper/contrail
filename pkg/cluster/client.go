...
func (c *Cluster) interfaceToOpenstackControlNode(openstackControlNodes interface{}) ([]*models.OpenstackControlNode, error) {
...
func (c *Cluster) interfaceToOpenstackMonitoringNode(openstackMonitoringNodes interface{}) ([]*models.OpenstackMonitoringNode, error) {
...
func (c *Cluster) interfaceToOpenstackNetworkNode(openstackNetworkNodes interface{}) ([]*models.OpenstackNetworkNode, error) {
	...
	for _, openstackNetworkNode := range openstackNetworkNodes.([]interface{}) {
		...
		openstackNetworkNodesData = append(openstackNetworkNodesData, openstackNetworkNodeInfo)
	}
	return openstackNetworkNodesData, nil
}

func (c *Cluster) interfaceToOpenstackStorageNode(openstackStorageNodes interface{}) ([]*models.ContrailConfigDatabaseNode, error) {
	...
	for _, openstackStorageNode := range openstackStorageNodes.([]interface{}) {
		openstackStorageNodeInfo := models.InterfaceToContrailConfigDatabaseNode(openstackStorageNode.(map[string]interface{}))
		// Read contrail role node to get the node refs information
		...
		openstackStorageNodesData = append(openstackStorageNodesData, openstackStorageNodeInfo)
	}
	return openstackStorageNodesData, nil
}

func (c *Cluster) interfaceToOpenstackComputeNode(openstackComputeNodes interface{}) ([]*models.OpenstackComputeNode, error) {
