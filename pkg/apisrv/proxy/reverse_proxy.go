...
// NewSingleHostReverseProxy returns a new ReverseProxy that routes URLs to the scheme, host, and base path
...
func NewSingleHostReverseProxy(targetURL *url.URL) *httputil.ReverseProxy {
	logrus.Warn("Hoge NewSingleHostReverseProxy")
...
func NewReverseProxy(targets []*endpoint.Endpoint, targetURL *url.URL) *httputil.ReverseProxy {
