...
// resourcePermission is the 2st level hash table to get objectType specific rules.
...
func CheckPermissions(ctx context.Context, l []*models.APIAccessList, aaaMode string, kind string, op Action) error {
	...
	globalPermission := make(tenantPermission)
...
// Add rules matching objectType and wild card rules from the rule list to resourcePermission table.
...
func (t tenantPermission) addAPIAccessRulesToHash(apiAccessRules []*models.APIAccessList) resourcePermission {
...
func crudToActionMap(crud string) []Action {
...
// Add rules to the resourcePermission hash table. resourcePermission hash table will have entries of the form
...
// Member:CRUD
func (r resourcePermission) objectTypePermAddToHash(ruleKind string, perm *models.RbacPermType) {

	if perm == nil {
		return
	}
	role := perm.GetRoleName()
	crud := crudToActionMap(perm.GetRoleCrud())
...
func (r resourcePermission) objectTypePermsAddToHash(ruleKind string, perms []*models.RbacPermType) {
...
func (r resourcePermission) objectTypeRuleAddToHash(rbacRule *models.RbacRuleType) {
...
func (r resourcePermission) rulesAddToHash(rbacRules []*models.RbacRuleType) {
