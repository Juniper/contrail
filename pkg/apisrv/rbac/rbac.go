...
type crudSet  map[constants.OpCRUD]bool
...
type request struct {
	...
	fieldName  string                    // Object Field name
...
func newCRUDSet() *crudSet {
	...
	var n crudSet
	n = make(map[constants.OpCRUD]bool)
	return &n
}
...
func newRequest(ctx context.Context, apiAccessRules []*models.APIAccessList,
	kind string, op constants.OpCRUD) *request {
...
func ValidateRequest(ctx context.Context, apiAccessRules []*models.APIAccessList,
	kind string, op constants.OpCRUD)  error {
