...
func TestRefRelaxGRPC(t *testing.T) {
	testGRPCServer(t, t.Name(), func(ctx context.Context, conn *grpc.ClientConn) {
		...
		project := integration.GRPCCreateProject(ctx, t, c, &models.Project{
			UUID:                 projectUUID,
			Name:                 projectUUID,
			ParentType:           "domain",
		...
		defer integration.GRPCDeleteProject(ctx, t, c, project.GetUUID())

		policy := integration.GRPCCreateNetworkPolicy(ctx, t, c, &models.NetworkPolicy{
		...
		defer func() {
			...
			integration.GRPCDeleteNetworkPolicy(ctx, t, c, policy.GetUUID())
		}()

		network := integration.GRPCCreateVirtualNetwork(ctx, t, c, &models.VirtualNetwork{
			ParentType: models.KindProject,
			ParentUUID: project.GetUUID(),
		...
		defer integration.GRPCDeleteVirtualNetwork(ctx, t, c, network.GetUUID())
