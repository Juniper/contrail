...
import (
  ...
  "github.com/Juniper/contrail/pkg/apisrv/client"
	contrailRun "github.com/Juniper/contrail/pkg/cmd/contrail"
...
func runReplicationTest(t *testing.T) {
  ...
  testServer := createDummyVNCServer(t, vncReqStore)
  defer testServer.Close()

  parsedURL, err := url.Parse(testServer.URL)
  assert.NoError(t, err, "while parsing dummy vnc server URL")
...
func createDummyVNCServer(t *testing.T,
