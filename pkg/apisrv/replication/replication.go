...
func (r *Replicator) portToVNCPort(port *models.Port) interface{} {
	var portVNC map[string]interface{}
	e, _ := json.Marshal(port)      // nolint: errcheck
	_ = json.Unmarshal(e, &portVNC) //nolint: errcheck
...
func (r *Replicator) vnToVNCVirtualNetwork(vn *models.VirtualNetwork) interface{} {
	var vnVNC map[string]interface{}
	e, _ := json.Marshal(vn)      // nolint: errcheck
	_ = json.Unmarshal(e, &vnVNC) //nolint: errcheck
