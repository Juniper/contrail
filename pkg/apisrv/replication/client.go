...
func (h *vncAPIHandle) ListConfigEndpoints() (
	endpoints []*models.Endpoint, err error) {

	request := &services.ListEndpointRequest{
		Spec: &baseservices.ListSpec{
			Fields: []string{"uuid", "parent_uuid"},
...
func (h *vncAPIHandle) readAuthEndpoint(clusterID string) (
...
func (h *vncAPIHandle) replicate(action, url string,
	data interface{}, response interface{}) {
	if h.clients == nil {
...
func (v *vncAPI) replicate(action, url string,
	data interface{}, response interface{}) {
