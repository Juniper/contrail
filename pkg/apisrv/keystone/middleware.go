...
func AuthMiddleware(authURL string, insecure bool, skipPath []string,
	endpointStore *apicommon.EndpointStore, dbService serviceif.Service) echo.MiddlewareFunc {
...
func AuthInterceptor(authURL string, insecure bool,
	endpointStore *apicommon.EndpointStore, dbService serviceif.Service) grpc.UnaryServerInterceptor {
	auth := newAuth(authURL, insecure)
