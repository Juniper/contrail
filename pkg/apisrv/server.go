...
func (s *Server) Init() (err error) {
	...
	if err = s.serveDynamicProxy(endpointStore); err != nil {
		return err
	}
...
func (s *Server) serveDynamicProxy(endpointStore *apicommon.EndpointStore) error {
	if err := s.registerProxyEndpoints(); err != nil {
		return errors.Wrap(err, "failed to register proxy endpoints")
	}
...
func (s *Server) registerProxyEndpoints() error {
