...
//this method.
func (s *Server) SetupService(dbService serviceif.Service) serviceif.Service {
...
func (s *Server) Init() error {
	...
	service := s.SetupService(dbService)
	...
	serveDynamicProxy(e, proxyEndpointStore, dbService)
