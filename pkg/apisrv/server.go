...
func NewServer(es endpointStore, cache *cache.DB) (*Server, error) {
	...
	plugins = append(plugins, extraNoAuthPathsPlugin{})
...
type extraNoAuthPathsPlugin struct{}

func (extraNoAuthPathsPlugin) RegisterHTTPAPI(r baseapisrv.HTTPRouter) {
	r.AddNoAuthPaths(
...
func (extraNoAuthPathsPlugin) RegisterGRPCAPI(r baseapisrv.GRPCRouter) {
}
