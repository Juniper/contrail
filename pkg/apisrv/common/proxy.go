...
// NewReverseProxy creates a reverse proxy that will randomly
// select a host from the passed `targets`
func NewReverseProxy(targets []*Endpoint) *httputil.ReverseProxy {
	...
	director := func(req *http.Request) {
		...
		req.URL.Host = u.Host // TODO: move that logic to Transport.Dial
	}
