...
func (m *mockContainerPlayer) Play(
	ctx context.Context, cp *ansible.ContainerParameters, ansibleArgs []string,
) error {
...
// TODO: ADD COMMAND TO MARSHALLING PROCESS
...
func manageCluster(t *testing.T, c *cluster.Config, player cluster.Player) {
