...
func upgradeOpenstackPlaybookExecutions() []ansiblemock.ContainerExecution {
	parameters := ansibleContainerParameters(
	...
	return []ansiblemock.ContainerExecution {
		defaultPlayBookExecution(
			"playbooks/provision_instances.yml", parameters, defaultInventory, defaultConfigFile, openstackOrch,
		),
		defaultPlayBookExecution(
			"playbooks/configure_instances.yml", parameters, defaultInventory, defaultConfigFile, openstackOrch,
		),
		defaultPlayBookExecution(
			"playbooks/install_openstack.yml", parameters, defaultInventory, defaultConfigFile, openstackOrch, forceCheckout,
		),
		defaultPlayBookExecution(
			"playbooks/install_contrail.yml", parameters, defaultInventory, defaultConfigFile, openstackOrch,
		),
	}
}
...
func deleteComputeOpenstackPlaybookExecutions() []ansiblemock.ContainerExecution {
	...
	return []ansiblemock.ContainerExecution {
		...
		defaultPlayBookExecution(
			"playbooks/install_openstack.yml", parameters, defaultInventory, defaultConfigFile, openstackOrch, forceCheckout, novaTag,
		),
		defaultPlayBookExecution(
			"playbooks/install_contrail.yml", parameters, defaultInventory, defaultConfigFile, openstackOrch,
		),
...
func addComputeOpenstackPlaybookExecutions() []ansiblemock.ContainerExecution {
	...
	return []ansiblemock.ContainerExecution {
		defaultPlayBookExecution(
			"playbooks/configure_instances.yml", parameters,
			defaultInventory, defaultConfigFile, openstackOrch,
		),
		defaultPlayBookExecution(
			"playbooks/install_openstack.yml", parameters,
			defaultInventory, defaultConfigFile, openstackOrch, forceCheckout, novaTag,
		),
		defaultPlayBookExecution(
			"playbooks/install_contrail.yml", parameters,
			defaultInventory, defaultConfigFile, openstackOrch,
		),
	}
}
...
func ansibleContainerParameters(imageRef, workingDirectory, volume string) *ansible.ContainerParameters {
...
func runTest(
	...
	for _, spec := range clusterActionSpecs {
		runClusterActionTest(t, ts, config, spec.action, expectedInstance, spec.expectedPlaybookExecutions, expectedEndpoints)
	}
...
func createUpdateAppformixPlaybookExecutions() []ansiblemock.ContainerExecution {
	...
	return []ansiblemock.ContainerExecution {
		...
		defaultPlayBookExecution(
			"playbooks/install_appformix.yml", appformixContainerParameters(), defaultConfigFile, defaultAppFormixVer, skipDockerInstall,
		),
	}
}
...
func destroyPlaybookExecutions() []ansiblemock.ContainerExecution {
	...
	return []ansiblemock.ContainerExecution {
		defaultPlayBookExecution(
			"playbooks/openstack_destroy.yml", parameters, defaultInventory,
		),
		defaultPlayBookExecution(
			"playbooks/contrail_destroy.yml", parameters, defaultInventory,
		),
	}
}
...
func createUpdateEncryptOpenstackPlaybookExecutions() []ansiblemock.ContainerExecution {
	...
	return []ansiblemock.ContainerExecution {
		...
		defaultPlayBookExecution(
			"playbooks/deploy_and_run_all.yml", parameters, encryptInventory,
		),
	}
}
...
func createUpdateKubernetesPlaybookExecutions() []ansiblemock.ContainerExecution {
	return []ansiblemock.ContainerExecution {
		defaultPlayBookExecution(
			"playbooks/provision_instances.yml", k8sContainerParameters(), defaultInventory, defaultConfigFile, k8sOrch,
		),
		defaultPlayBookExecution(
			"playbooks/configure_instances.yml", k8sContainerParameters(), defaultInventory, defaultConfigFile, k8sOrch,
		),
		defaultPlayBookExecution(
			"playbooks/install_k8s.yml", k8sContainerParameters(), defaultInventory, defaultConfigFile, k8sOrch,
		),
		defaultPlayBookExecution(
			"playbooks/install_contrail.yml", k8sContainerParameters(), defaultInventory, defaultConfigFile, k8sOrch,
		),
	}
}
...
func k8sContainerParameters() *ansible.ContainerParameters {
	return ansibleContainerParameters(
		"test_registry/contrail-kolla-ansible-deployer:ocata-5.0-x",
		cluster.DefaultAnsibleRepoInContainer,
		"/tmp/contrail_cluster",
...
func createUpdateVCenterPlaybookExecutions() []ansiblemock.ContainerExecution {
	...
	return []ansiblemock.ContainerExecution {
		defaultPlayBookExecution(
			"playbooks/provision_instances.yml", parameters, defaultInventory, defaultConfigFile, vcenterOrch,
		),
		defaultPlayBookExecution(
			"playbooks/vcenter.yml", parameters, defaultInventory, defaultConfigFile, vcenterOrch,
		),
		defaultPlayBookExecution(
			"playbooks/configure_instances.yml", parameters, defaultInventory, defaultConfigFile, vcenterOrch,
		),
		defaultPlayBookExecution(
			"playbooks/install_contrail.yml", parameters, defaultInventory, defaultConfigFile, vcenterOrch,
		),
	}
}
