...
func (a *contrailAnsibleDeployer) xflowVenvDir() string {
	return filepath.Join(a.getWorkingDir(), "xflow-venv")
}

func (a *contrailAnsibleDeployer) createVenv(venvDir string, requirements ...string) error {
	err := osutil.ExecCmdAndWait(a.Reporter, "pip", []string{"install", "virtualenv==16.4.3"}, "")
	if err != nil {
		return err
	}

	err = osutil.ExecCmdAndWait(a.Reporter, "python", []string{"-m", "virtualenv", venvDir}, "")
	if err != nil {
		return err
	}
...
func (a *contrailAnsibleDeployer) createAppfromixVenv() error {
	return a.createVenv(a.appformixVenvDir(),
		"ansible==2.4.2.0",
		"requests==2.21.0",
	)
}

func (a *contrailAnsibleDeployer) createXflowVenv() error {
	return a.createVenv(a.xflowVenvDir(),
		"ansible==2.5.2.0",
	)
}
