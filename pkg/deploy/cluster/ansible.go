...
func (a *contrailAnsibleDeployer) createInstancesFile(destination string) error {
	...
	if err := createFileFromTemplate(a.getInstanceTemplate(), destination, context); err != nil {
		return err
	}
...
func (a *contrailAnsibleDeployer) createDatapathEncryptionInventory(destination string) error {
	...
	if err := createFileFromTemplate(a.getInventoryTemplate(), destination, context); err != nil {
		return err
	}
...
func (a *contrailAnsibleDeployer) createVcenterVarsFile(destination string) error {
	...
	if err := createFileFromTemplate(a.getVcenterTemplate(), destination, context); err != nil {
		return err
	}
