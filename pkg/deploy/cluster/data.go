...
func (a *AppformixData) interfaceToAppformixControllerNode(appformixControllerNodes []*models.AppformixControllerNode, c *Cluster) error {
...
func (a *AppformixData) interfaceToAppformixBareHostNode(appformixBareHostNodes []*models.AppformixBareHostNode, c *Cluster) error {
...
func (a *AppformixData) interfaceToAppformixOpenstackNode(appformixOpenstackNodes []*models.AppformixOpenstackNode, c *Cluster) error {
...
func (a *AppformixData) interfaceToAppformixComputeNode(appformixComputeNodes []*models.AppformixComputeNode, c *Cluster) error {
