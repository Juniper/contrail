...
func TestApplyTemplatesGeneratesFilesFilledWithData(t *testing.T) {
	...
	testutil.AssertContainsStrings(t, []string{"ipam_subnets", "uuid", "display_name"}, loadStrings(t, networkIPAMResourcePath))
	testutil.AssertContainsStrings(t, []string{"display_name", "ipam_subnets", "uuid"}, loadStrings(t, networkIPAMTypePath))
	...
	testutil.AssertContainsStrings(t, []string{"uuid", "display_name", "virtual_network_network_id"}, loadStrings(t, vnResourcePath))
	testutil.AssertContainsStrings(t, []string{"virtual_network_network_id", "uuid", "display_name"}, loadStrings(t, vnTypePath))
...
func TestApplyTemplatesAddsGenerationPrefix(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Nil(t, err)
			assert.Contains(t, loadString(t, tt.filePath), tt.expectedPrefix)
		})
	}
}
