...
func (tc *TemplateConfig) getOutputPathFromTemplatePath() string {
	return filepath.Join(tc.getTemplateFileDirectory(), tc.getOutputFileNameWithSpecifiedExtension())
}

func (tc *TemplateConfig) getOutputFileNameWithSpecifiedExtension() string {
