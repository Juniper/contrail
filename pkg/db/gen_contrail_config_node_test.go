...
func TestContrailConfigNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailConfigNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailConfigNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetContrailConfigNode(ctx, &models.GetContrailConfigNodeRequest{
		ID: model.UUID})
	if err == nil {
