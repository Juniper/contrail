...
func TestOpenstackControlNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackControlNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackControlNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetOpenstackControlNode(ctx, &models.GetOpenstackControlNodeRequest{
		ID: model.UUID})
	if err == nil {
