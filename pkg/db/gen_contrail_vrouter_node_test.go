...
func TestContrailVrouterNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailVrouterNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailVrouterNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetContrailVrouterNode(ctx, &models.GetContrailVrouterNodeRequest{
		ID: model.UUID})
	if err == nil {
