...
func deleteFQNameRow(b *gocql.Batch, r services.Resource) {
	withTimestamp(b, deleteFromFQNameTable, r.Kind(), getFQNameToUUIDColumn1(r))
}

func createFQNameRow(b *gocql.Batch, r services.Resource) {
	withTimestamp(b, insertIntoFQNameTable, r.Kind(), getFQNameToUUIDColumn1(r), "null")
}

func updateFQNameRow(b *gocql.Batch, r services.Resource) {
	deleteFQNameRow(b, r)
	createFQNameRow(b, r)
}
...
func isMetadataRow(r string) bool {
	return strings.HasPrefix(r, "META:")
}

func isParentRow(r string) bool {
	return strings.HasPrefix(r, "parent:")
}

func isPropRow(r string) bool {
	return strings.HasPrefix(r, "prop:")
}

func isProplRow(r string) bool {
	return strings.HasPrefix(r, "propl:")
}

func isPropmRow(r string) bool {
	return strings.HasPrefix(r, "propm:")
}
