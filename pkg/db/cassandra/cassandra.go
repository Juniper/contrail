...
//EventProducer makes new event processor for cassandra.
func NewEventProducer(processor services.EventProcessor, queueName, cassandraHost, rabbitMQHost string) *EventProducer {
