			...
			expected: map[string]expectedResult{
				MYSQL: {
					query: "select" +
						...
						",(select group_concat(JSON_OBJECT('uuid',`virtual_machine_interface_t`.`uuid`)) as `ref_virtual_machine_interface_virtual_network_backref` from `virtual_machine_interface` as virtual_machine_interface_t inner join ref_virtual_machine_interface_virtual_network as ref_virtual_machine_interface_virtual_network_t on `ref_virtual_machine_interface_virtual_network_t`.`from` = `virtual_machine_interface_t`.`uuid` where `ref_virtual_machine_interface_virtual_network_t`.`to` = `virtual_network_t`.`uuid` )" +
				...
				POSTGRES: {
					query: `select` +
						...
						`,(select json_agg(row_to_json("virtual_machine_interface_t")) as "ref_virtual_machine_interface_virtual_network_backref" from "virtual_machine_interface" as virtual_machine_interface_t inner join ref_virtual_machine_interface_virtual_network as ref_virtual_machine_interface_virtual_network_t on "ref_virtual_machine_interface_virtual_network_t"."from" = "virtual_machine_interface_t"."uuid" where "ref_virtual_machine_interface_virtual_network_t"."to" = "virtual_network_t"."uuid" )` +
