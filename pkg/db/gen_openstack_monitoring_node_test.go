...
func TestOpenstackMonitoringNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackMonitoringNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackMonitoringNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetOpenstackMonitoringNode(ctx, &models.GetOpenstackMonitoringNodeRequest{
		ID: model.UUID})
	if err == nil {
