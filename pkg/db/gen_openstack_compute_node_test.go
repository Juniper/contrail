...
func TestOpenstackComputeNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackComputeNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackComputeNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetOpenstackComputeNode(ctx, &models.GetOpenstackComputeNodeRequest{
		ID: model.UUID})
	if err == nil {
