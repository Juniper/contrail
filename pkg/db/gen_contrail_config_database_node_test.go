...
func TestContrailConfigDatabaseNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailConfigDatabaseNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailConfigDatabaseNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetContrailConfigDatabaseNode(ctx, &models.GetContrailConfigDatabaseNodeRequest{
		ID: model.UUID})
	if err == nil {
