...
func TestContrailControlNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailControlNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.ContrailControlNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetContrailControlNode(ctx, &models.GetContrailControlNodeRequest{
		ID: model.UUID})
	if err == nil {
