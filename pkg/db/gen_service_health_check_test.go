...
func TestServiceHealthCheck(t *testing.T) {
	...
	ServiceInstanceCreateRef = append(ServiceInstanceCreateRef,
		&models.ServiceHealthCheckServiceInstanceRef{UUID: ServiceInstanceRefUUID, To: []string{"test", ServiceInstanceRefUUID}})
	ServiceInstanceCreateRef = append(ServiceInstanceCreateRef,
		&models.ServiceHealthCheckServiceInstanceRef{UUID: ServiceInstanceRefUUID2, To: []string{"test", ServiceInstanceRefUUID2}})
	...
	_, err = db.GetServiceHealthCheck(ctx, &models.GetServiceHealthCheckRequest{
		ID: model.UUID})
	if err == nil {
