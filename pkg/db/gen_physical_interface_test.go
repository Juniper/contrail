...
func TestPhysicalInterface(t *testing.T) {
	...
	PhysicalInterfaceCreateRef = append(PhysicalInterfaceCreateRef,
		&models.PhysicalInterfacePhysicalInterfaceRef{UUID: PhysicalInterfaceRefUUID, To: []string{"test", PhysicalInterfaceRefUUID}})
	PhysicalInterfaceCreateRef = append(PhysicalInterfaceCreateRef,
		&models.PhysicalInterfacePhysicalInterfaceRef{UUID: PhysicalInterfaceRefUUID2, To: []string{"test", PhysicalInterfaceRefUUID2}})
	...
	_, err = db.GetPhysicalInterface(ctx, &models.GetPhysicalInterfaceRequest{
		ID: model.UUID})
	if err == nil {
