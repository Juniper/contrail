...
func addWatcher(t *testing.T, wg *sync.WaitGroup, cache *CacheDB) {
...
func notifyEvent(cache *CacheDB, version uint64) {
...
// nolint: unused
func notifyDelete(cache *CacheDB, version uint64) {
	event := &services.Event{
		Version: version,
...
func (cache *CacheDB) processTestEvent(event *services.Event) (*services.Event, error) {
