...
func TestKubernetesNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.KubernetesNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.KubernetesNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetKubernetesNode(ctx, &models.GetKubernetesNodeRequest{
		ID: model.UUID})
	if err == nil {
