...
func TestAppformixNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.AppformixNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.AppformixNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetAppformixNode(ctx, &models.GetAppformixNodeRequest{
		ID: model.UUID})
	if err == nil {
