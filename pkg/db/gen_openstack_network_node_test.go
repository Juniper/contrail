...
func TestOpenstackNetworkNode(t *testing.T) {
	...
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackNetworkNodeNodeRef{UUID: NodeRefUUID, To: []string{"test", NodeRefUUID}})
	NodeCreateRef = append(NodeCreateRef,
		&models.OpenstackNetworkNodeNodeRef{UUID: NodeRefUUID2, To: []string{"test", NodeRefUUID2}})
	...
	_, err = db.GetOpenstackNetworkNode(ctx, &models.GetOpenstackNetworkNodeRequest{
		ID: model.UUID})
	if err == nil {
