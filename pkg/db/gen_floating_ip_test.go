...
func TestFloatingIP(t *testing.T) {
	...
	ProjectCreateRef = append(ProjectCreateRef,
		&models.FloatingIPProjectRef{UUID: ProjectRefUUID, To: []string{"test", ProjectRefUUID}})
	ProjectCreateRef = append(ProjectCreateRef,
		&models.FloatingIPProjectRef{UUID: ProjectRefUUID2, To: []string{"test", ProjectRefUUID2}})
	...
	VirtualMachineInterfaceCreateRef = append(VirtualMachineInterfaceCreateRef,
		&models.FloatingIPVirtualMachineInterfaceRef{UUID: VirtualMachineInterfaceRefUUID, To: []string{"test", VirtualMachineInterfaceRefUUID}})
	VirtualMachineInterfaceCreateRef = append(VirtualMachineInterfaceCreateRef,
		&models.FloatingIPVirtualMachineInterfaceRef{UUID: VirtualMachineInterfaceRefUUID2, To: []string{"test", VirtualMachineInterfaceRefUUID2}})
	...
	_, err = db.GetFloatingIP(ctx, &models.GetFloatingIPRequest{
		ID: model.UUID})
	if err == nil {
