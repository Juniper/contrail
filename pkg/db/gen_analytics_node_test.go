...
func TestAnalyticsNode(t *testing.T) {
	...
	// mutexProject := UseTable(db.DB, "analytics_node")
	defer func() {
		mutexTable.Unlock()
	...
	projectModel.UUID = "analytics_node_admin_project_uuid"
	...
	//
	//
	//    common.SetValueByPath(updateMap, ".AnalyticsNodeIPAddress", ".", "test")
	//
	//
	//    common.SetValueByPath(updateMap, "uuid", ".", "analytics_node_dummy_uuid")
	...
	//        return UpdateAnalyticsNode(tx, model.UUID, updateMap)
	//    })
	//    if err != nil {
