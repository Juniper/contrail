...
func (p *AuthPlugin) RegisterHTTPAPI(r baseapisrv.HTTPRouter) error {
	r.Use(p.middleware)
	return nil
}
...
//nolint: gocyclo
func (p *AuthPlugin) middleware(next echo.HandlerFunc) echo.HandlerFunc {
...
func (p *AuthPlugin) RegisterGRPCAPI(r baseapisrv.GRPCRouter) error {
	// TODO Use AuthInterceptor
	return nil
}
