...
func (service *ContrailService) PropCollectionUpdate(ctx context.Context, request *PropCollectionUpdateRequest) (*types.Empty, error) {
...
func (c *PropCollectionChange) UnmarshalJSON(b []byte) error {
	val := c.ValueAsInterface()
	if val == nil {
