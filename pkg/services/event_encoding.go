...
func (e *Event) ExtractRefEvents() (EventList, error) {
	...
	case DeleteEventRequest:
		//return makeRefEventList(r.GetResource(), RefOperationDelete)
		return EventList{}, nil
	default:
...
func extractRefEvents(r basemodels.Object, o RefOperation) (EventList, error) {
	...
	r.RemoveReferences()
	return makeRefEventList(r.GetUUID(), refs, o)
}

func makeRefEventList(uuid string, refs basemodels.References, operation RefOperation)  (EventList, error) {
	el := EventList{}
