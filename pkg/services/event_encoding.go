...
// Events is a slice of Event pointers.
type Events []*Event
...
// Sort events in EventList by parent-child dependency using Tarjan algorithm.
// See Events.Sort() for more information.
...
// Deduplicate merges events that refer to the same object and returns a list that contains minimal
// events that cause same state changes after applying them.
