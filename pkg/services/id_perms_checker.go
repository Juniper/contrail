...
func getStoredIDPerms(ctx context.Context, service *ContrailService, typeName, uuid string) (*models.IdPermsType, error) {
	base, err := GetObject(ctx, &service.BaseService, typeName, uuid)
	if err != nil {
		return nil, err
	}
