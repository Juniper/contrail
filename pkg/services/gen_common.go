...
func (service *ContrailService) RegisterRESTAPI(e *echo.Echo) {
	...
	e.POST("/keypairs", service.RESTCreateKeypair)
	e.GET("/keypairs", service.RESTListKeypair)
	e.PUT("/keypair/:id", service.RESTUpdateKeypair)
	e.GET("/keypair/:id", service.RESTGetKeypair)
	e.DELETE("/keypair/:id", service.RESTDeleteKeypair)
