...
func SetupService(apiService services.WriteService, allocator services.IntPoolAllocator) *compilationif.CompilationService {
	// create services
	compilationService := compilationif.NewCompilationService()
	logicService := logic.NewService(apiService, allocator)
