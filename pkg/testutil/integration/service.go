...
func CreateProject(
	ctx context.Context, t *testing.T, s services.WriteService, obj *models.Project,
) *models.Project {
...
func CreateNetworkIpam(
	ctx context.Context, t *testing.T, s services.WriteService, obj *models.NetworkIpam,
) *models.NetworkIpam {
