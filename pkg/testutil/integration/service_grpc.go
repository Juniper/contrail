...
func GRPCCreateProject(ctx context.Context, t *testing.T, s services.ContrailServiceClient, obj *models.Project) *models.Project {
...
func GRPCDeleteProject(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) {
...
func GRPCGetProject(t *testing.T, s services.ContrailServiceClient, ctx context.Context, id string) *models.Project {
...
func GRPCCreateNetworkIpam(ctx context.Context, t *testing.T, s services.ContrailServiceClient, obj *models.NetworkIpam) *models.NetworkIpam {
...
func GRPCDeleteNetworkIpam(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) {
...
func GRPCGetNetworkIpam(t *testing.T, s services.ContrailServiceClient, ctx context.Context, id string) *models.NetworkIpam {
...
func GRPCCreateNetworkPolicy(ctx context.Context, t *testing.T, s services.ContrailServiceClient, obj *models.NetworkPolicy) *models.NetworkPolicy {
...
func GRPCDeleteNetworkPolicy(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) {
...
func GRPCGetNetworkPolicy(t *testing.T, s services.ContrailServiceClient, ctx context.Context, id string) *models.NetworkPolicy {
...
func GRPCCreateVirtualNetwork(ctx context.Context, t *testing.T, s services.ContrailServiceClient, obj *models.VirtualNetwork) *models.VirtualNetwork {
...
func GRPCDeleteVirtualNetwork(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) {
...
func GRPCGetVirtualNetwork(t *testing.T, s services.ContrailServiceClient, ctx context.Context, id string) *models.VirtualNetwork {
...
func GRPCDeleteSecurityGroup(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) {
...
func GRPCDeleteAccessControlList(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) {
