...
func GRPCGetProject(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) *models.Project {
...
func GRPCGetNetworkIpam(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) *models.NetworkIpam {
...
func GRPCGetNetworkPolicy(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) *models.NetworkPolicy {
...
func GRPCGetVirtualNetwork(ctx context.Context, t *testing.T, s services.ContrailServiceClient, id string) *models.VirtualNetwork {
