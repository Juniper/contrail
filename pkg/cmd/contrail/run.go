...
func StartVNCReplicator(s *apisrv.Server, endpointStore *endpoint.Store) (vncReplicator *replication.Replicator, err error) {
	vncReplicator, err = replication.New(endpointStore, s.Keystone)
	if err != nil {
		return nil, err
	}
