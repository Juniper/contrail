...
func applyValue(v reflect.Value, i interface{}) error {
	if !v.CanSet() || !v.CanInterface() || !v.CanAddr() {
	...
	case reflect.Ptr, reflect.Struct:
		return applyInterfaceOnStruct(i, v.Addr().Interface())
	case reflect.Interface:
		...
		return applyInterfaceOnStruct(i, v.Interface())
	case reflect.Map:
...
func applyInterfaceOnStruct(i interface{}, s interface{}) error {
