...
var numericTests = []struct {
	...
	{
		name:     "casting int(4) to int should return 4",
		input:    int(4),
		expected: 4,
	},
	{
		name:     "casting int64(4) to int should return 4",
		input:    int64(4),
		expected: 4,
	},
	{
		name:     "casting float64(4.02) to int should return 4",
		input:    float64(4.02),
		expected: 4,
	},
	{
		name:     "casting int8(4) to int is not supported, should return 0",
		input:    int8(4),
		expected: 0,
	},
	{
		name:     `casting []byte("4") to int should return 4`,
		input:    []byte("4"),
		expected: 4,
	},
	{
		name:     `casting negative []byte("-4") to int should return -4`,
		input:    []byte("-4"),
		expected: -4,
	},
	{
		name:     `casting byte slice with wrong string escape []byte(\""-4"\") should return 0`,
		input:    []byte(`\"-4\"`),
		expected: 0,
	},
	{
		name:     `casting big negative num []byte("-9223372036854775808") to int should return -9223372036854775808`,
		input:    []byte("-9223372036854775808"),
		expected: -9223372036854775808,
	},
	{
		name:     `casting "4" to int should return 4`,
		input:    "4",
		expected: 4,
	},
	{
