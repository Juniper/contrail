...
func (c *DockerClient) Play(
	...
	err = c.execCmd(ctx, containerName, cmd, true)
	if err != nil {
		return err
	}
...
func (c *DockerClient) execCmd(ctx context.Context, containerName string, cmd *exec.Cmd, writeLog bool) error {
	...
	defer hijack.Close()
	// TODO: is this the correct way to log ansible deployment output
