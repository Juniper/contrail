...
const typeVncAPILatencyStatsLog = "VncApiLatencyStatsLog"
...
func VncAPILatencyStatsLog(ctx context.Context, operation, application string,
	responseTime int64) collector.MessageBuilder {
