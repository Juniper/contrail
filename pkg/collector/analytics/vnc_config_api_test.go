...
func TestVNCAPIConfigLog(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx.Set(collector.KeyVNCAPIConfigLogMetadata, tt.metadata)
			ctx.Set(collector.KeyVNCAPIConfigLogOperation, tt.operation)
			ctx.Set(collector.KeyVNCAPIConfigLogError, tt.error)
