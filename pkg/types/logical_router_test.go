...
func TestCreateLogicalRouter(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			createCall := service.Next().(*servicesmock.MockService).
				EXPECT().CreateLogicalRouter(gomock.Not(gomock.Nil()), gomock.Not(gomock.Nil())).DoAndReturn(
...
func TestUpdateLogicalRouter(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			updateCall := service.Next().(*servicesmock.MockService).
				EXPECT().UpdateLogicalRouter(gomock.Not(gomock.Nil()), gomock.Not(gomock.Nil())).DoAndReturn(
