...
func getTenantAcess(createResponse *services.CreateDomainResponse, uuid string) int64 {
...
func TestCreateDomain(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equal(t, getTenantAcess(createDomainResponse, tt.createRequest.Domain.UUID), int64(basemodels.PermsRW))
		})
	}
}
