...
func (sv *ContrailTypeLogicService) reserveVirtualNetworkVxLANID(ctx context.Context, virtualNetwork *models.VirtualNetwork) error {
...
func (sv *ContrailTypeLogicService) deallocateVirtualNetworkVxLANID(ctx context.Context, virtualNetwork *models.VirtualNetwork) error {
	vxLANID := virtualNetwork.GetVirtualNetworkProperties().GetVxlanNetworkIdentifier()
	if vxLANID == 0 {
		return nil
	}
