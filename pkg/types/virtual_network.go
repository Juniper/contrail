...
func (sv *ContrailTypeLogicService) CreateVirtualNetwork(
	...
	err = sv.InTransactionDoer.DoInTransaction(
		...
		func(ctx context.Context) error {
			...
			if vxLanID != 0 {
				err = sv.IntPoolAllocator.SetInt(ctx, VirtualNetworkIDPoolKey, vxLanID)
				if err != nil {
...
func (sv *ContrailTypeLogicService) UpdateVirtualNetwork(
	...
	err = sv.InTransactionDoer.DoInTransaction(
		...
		func(ctx context.Context) error {
			...
			// TODO process VxlanNetworkIdentifier update:
			// TODO deallocate the old one and set the new one.
