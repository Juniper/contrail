...
func (sv *ContrailTypeLogicService) CreateVirtualNetwork(
	...
	if err = sv.validateRequestedVirtualNetwork(virtualNetwork); err != nil {
		return nil, err
	}
...
func (sv *ContrailTypeLogicService) validateRequestedVirtualNetwork(vn *models.VirtualNetwork) error {
