...
func (sv *ContrailTypeLogicService) checkVirtualNetworkID(
	...
	if !strings2.ContainsString(fieldMask.GetPaths(), models.VirtualNetworkFieldVirtualNetworkNetworkID) {
		return nil
	}
...
func (sv *ContrailTypeLogicService) checkIsProviderNetwork(
	...
	if !strings2.ContainsString(fieldMask.GetPaths(), models.VirtualNetworkFieldIsProviderNetwork) {
		return nil
	}
...
func (sv *ContrailTypeLogicService) isProviderNetwork(
	...
	if currentVN != nil && !strings2.ContainsString(fieldMask.GetPaths(), models.VirtualNetworkFieldIsProviderNetwork) {
