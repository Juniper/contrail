...
func validateMultiPolicyServiceChainConfigWithUpdate(
	...
	if basemodels.FieldMaskContains(&fieldMask, models.VirtualNetworkFieldImportRouteTargetList) {
		oldVN.ImportRouteTargetList = updateVN.ImportRouteTargetList
	}
	if basemodels.FieldMaskContains(&fieldMask, models.VirtualNetworkFieldExportRouteTargetList) {
		oldVN.ExportRouteTargetList = updateVN.ExportRouteTargetList
	}
	if basemodels.FieldMaskContains(&fieldMask, models.VirtualNetworkFieldRouteTargetList) {
