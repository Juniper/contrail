...
var defaultGSCFqName = []string{"default-global-system-config"}
...
func (sv *ContrailTypeLogicService) CreateQosConfig(
	...
	err = sv.InTransactionDoer.DoInTransaction(
		...
		func(ctx context.Context) error {
			...
			qos.AddDefaultGlobalSystemConfigRef(defaultGSCUUID, defaultGSCFqName)
...
func (sv *ContrailTypeLogicService) getDefaultGlobalSystemConfigUUID(ctx context.Context) (string, error) {
	defaultGSC, err := sv.MetadataGetter.GetMetadata(
		ctx,
		basemodels.Metadata{
