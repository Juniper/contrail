...
func (sv *ContrailTypeLogicService) CreateServiceTemplate(
	...
	err = sv.InTransactionDoer.DoInTransaction(
		...
		func(ctx context.Context) error {
			...
			perms2.Share = append(perms2.GetShare(), &shareItem)
...
func (sv *ContrailTypeLogicService) getParentDomainUUIDFromFQName(
	ctx context.Context,
	serviceTemplate *models.ServiceTemplate,
) (string, error) {
	fqRequest := services.FQNameToIDRequest{
		FQName: serviceTemplate.GetFQName(),
		Type:   serviceTemplate.GetParentType(),
	}
