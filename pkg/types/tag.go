...
func (sv *ContrailTypeLogicService) CreateTag(
	...
	err := sv.InTransactionDoer.DoInTransaction(
		...
		func(ctx context.Context) (err error) {
			...
			// tagType.TagRefs = append(tagType.TagRefs, &models.TagTypeTagRef{
			...
			// 		Paths: []string{models.TagFieldTagRefs},
			// 	},
			// })
...
func (sv *ContrailTypeLogicService) DeleteTag(
	...
	err := sv.InTransactionDoer.DoInTransaction(
		...
		func(ctx context.Context) (err error) {
			...
			// sv.tryDeleteTagType(ctx, tagType)
...
func (sv *ContrailTypeLogicService) tryDeleteTagType(ctx context.Context, tagType *models.TagType) {
	if len(tagType.GetTagRefs()) == 0 {
