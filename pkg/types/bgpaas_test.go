...
func nextServMock(t *testing.T, service *ContrailTypeLogicService, getResp *services.GetBGPAsAServiceResponse) {
	...
	nextServiceMock.EXPECT().CreateBGPAsAService(gomock.Any(), gomock.Any()).DoAndReturn(
		func(
			_ context.Context, request *services.CreateBGPAsAServiceRequest,
	...
	nextServiceMock.EXPECT().UpdateBGPAsAService(gomock.Any(), gomock.Any()).DoAndReturn(
		func(
			_ context.Context, request *services.UpdateBGPAsAServiceRequest,
	...
	nextServiceMock.EXPECT().GetBGPAsAService(gomock.Any(), gomock.Any()).DoAndReturn(
		func(
			_ context.Context, request *services.GetBGPAsAServiceRequest,
