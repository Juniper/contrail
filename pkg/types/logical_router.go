...
func (sv *ContrailTypeLogicService) checkForExternalGateway(
	...
	if fm != nil && !baseservices.FieldMaskContains(*fm, models.LogicalRouterFieldParentUUID) &&
		!baseservices.FieldMaskContains(*fm, models.LogicalRouterFieldVirtualNetworkRefs) {
		return nil
	}
