...
func networkIpamNextServMocks(service *ContrailTypeLogicService) {
	...
	nextServiceMock.EXPECT().UpdateNetworkIpam(gomock.Any(), gomock.Any()).DoAndReturn(
		func(ctx context.Context, request *services.UpdateNetworkIpamRequest) (response *services.UpdateNetworkIpamResponse, err error) {
...
func TestUpdateNetworkIpam(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			fieldMask: []string{models.NetworkIpamPropertyIDIpamSubnetMethod},
			fails:     true,
		},
		{
			...
			oldNetworkIpamParams: &testNetIpamParams{
				...
				virtualNetworkBackRefs: []*models.VirtualNetwork{{UUID: "vnUUID", VirtualMachineInterfaceBackRefs: []*models.VirtualMachineInterface{{UUID: "vmUUID"}}}},
			},
			newNetworkIpamParams: &testNetIpamParams{
				networkIpamMGMT: &models.IpamType{IpamDNSMethod: "tenant-dns-server"},
			},
			fieldMask: []string{models.NetworkIpamPropertyIDNetworkIpamMGMT},
			fails:     true,
		},
		{
		...
		{
			name: "Update network ipam where dns method is changed tenant",
			oldNetworkIpamParams: &testNetIpamParams{
				networkIpamMGMT:        &models.IpamType{IpamDNSMethod: "tenant-dns-server"},
				virtualNetworkBackRefs: []*models.VirtualNetwork{{UUID: "vnUUID", VirtualMachineInterfaceBackRefs: []*models.VirtualMachineInterface{{UUID: "vmUUID"}}}},
			},
		...
		},
		{
			...
			fieldMask: []string{models.NetworkIpamPropertyIDIpamSubnets},
			fails:     true,
		},
		{
			...
			newNetworkIpamParams: &testNetIpamParams{
				uuid:             "ipamUUID",
				ipamSubnetMethod: "flat-subnet",
				ipamSubnets: &models.IpamSubnets{Subnets: []*models.IpamSubnetType{{Subnet: &models.SubnetType{IPPrefix: "10.0.0.0", IPPrefixLen: 24}}, {Subnet: &models.SubnetType{IPPrefix: "10.0.0.0", IPPrefixLen: 24}}}},
			},
			fieldMask: []string{models.NetworkIpamPropertyIDIpamSubnets},
			fails:     true,
		},
		{
			...
			newNetworkIpamParams: &testNetIpamParams{
				uuid:             "ipamUUID",
				ipamSubnetMethod: "flat-subnet",
				ipamSubnets: &models.IpamSubnets{Subnets: []*models.IpamSubnetType{{Subnet: &models.SubnetType{IPPrefix: "11.0.0.0", IPPrefixLen: 24}}}},
			},
			fieldMask: []string{models.NetworkIpamPropertyIDIpamSubnets},
			fails:     false,
		},
		{
			...
			oldNetworkIpamParams: &testNetIpamParams{
				...
				ipamSubnetMethod: "flat-subnet",
				ipamSubnets: &models.IpamSubnets{Subnets: []*models.IpamSubnetType{{Subnet: &models.SubnetType{IPPrefix: "10.0.0.0", IPPrefixLen: 24}}}},
				virtualNetworkBackRefs: []*models.VirtualNetwork{{InstanceIPBackRefs: []*models.InstanceIP{{InstanceIPAddress: "10.0.0.5"}}}},
			},
			newNetworkIpamParams: &testNetIpamParams{
				uuid:             "ipamUUID",
				ipamSubnetMethod: "flat-subnet",
		...
		},
		{
			...
			oldNetworkIpamParams: &testNetIpamParams{
				...
				ipamSubnetMethod: "flat-subnet",
				ipamSubnets: &models.IpamSubnets{Subnets: []*models.IpamSubnetType{{Subnet: &models.SubnetType{IPPrefix: "10.0.0.0", IPPrefixLen: 24}}}},
				virtualNetworkBackRefs: []*models.VirtualNetwork{{FloatingIPPools: []*models.FloatingIPPool{{FloatingIPs: []*models.FloatingIP{{FloatingIPAddress: "10.0.0.5"}}}}}},
			},
			newNetworkIpamParams: &testNetIpamParams{
				uuid:             "ipamUUID",
				ipamSubnetMethod: "flat-subnet",
		...
		},
		{
			...
			oldNetworkIpamParams: &testNetIpamParams{
				...
				ipamSubnetMethod: "flat-subnet",
				ipamSubnets: &models.IpamSubnets{Subnets: []*models.IpamSubnetType{{Subnet: &models.SubnetType{IPPrefix: "10.0.0.0", IPPrefixLen: 24}}}},
				virtualNetworkBackRefs: []*models.VirtualNetwork{{AliasIPPools: []*models.AliasIPPool{{AliasIPs: []*models.AliasIP{{AliasIPAddress: "10.0.0.5"}}}}}},
			},
			newNetworkIpamParams: &testNetIpamParams{
				uuid:             "ipamUUID",
				ipamSubnetMethod: "flat-subnet",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			fMask := types.FieldMask{Paths: tt.fieldMask}
