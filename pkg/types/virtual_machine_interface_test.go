...
func deleteTestMockNoVMIs(s *ContrailTypeLogicService) {
	readService := s.ReadService.(*servicesmock.MockReadService) //nolint: errcheck
...
func deleteTestMockVmiNextService(s *ContrailTypeLogicService, vmiUUID string) {
	nextService := s.Next().(*servicesmock.MockService) //nolint: errcheck
...
func deleteTestMockVmiNoBindings(s *ContrailTypeLogicService) {
	...
	deleteTestMockVmiNextService(s, vmiUUID)
}

func deleteTestMockVmiVRouterInBindings(s *ContrailTypeLogicService) {
	...
	metadataGetterService.EXPECT().GetMetadata(
		gomock.Not(gomock.Nil()), basemodels.Metadata{
			Type: "virtual_router",
			FQName: []string{defaultGSCName,
				"host-id0001-352d23"}},
...
func TestDeleteVirtualMachineInterface(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			mockSetUp: func(service *ContrailTypeLogicService) {
				deleteTestMockVmiNoBindings(service)
			},
			expectedErr: "",
			statusCode:  codes.OK,
		},
		{
			...
			mockSetUp: func(service *ContrailTypeLogicService) {
				deleteTestMockVmiVRouterInBindings(service)
			},
			expectedErr: "",
			statusCode:  codes.OK,
		},
...
func updateTestMockVmiNoBindings(s *ContrailTypeLogicService) {
	...
	updateTestMockVmiNextService(s, vmi)
}

func updateTestMockVmiNextService(s *ContrailTypeLogicService, vmi *models.VirtualMachineInterface) {
	nextService := s.Next().(*servicesmock.MockService) //nolint: errcheck
...
func updateTestMockDatabaseVmi(s *ContrailTypeLogicService, vmi *models.VirtualMachineInterface) {
...
func updateTestMockMetadataGetter(s *ContrailTypeLogicService) {
	metadataGetterService := s.MetadataGetter.(*typesmock.MockMetadataGetter) //nolint: errcheck
	metadataGetterService.EXPECT().GetMetadata(
		gomock.Not(gomock.Nil()), basemodels.Metadata{
			Type: "virtual_router",
...
func updateTestMockEmptyVRouterRefs(s *ContrailTypeLogicService) {
	updateTestMockMetadataGetter(s)
	vmi := &models.VirtualMachineInterface{
		UUID: "2d9ebd36-709e-450a-8825-581997d06090",
		Name: "Base Mock",
	}
...
func updateTestMockDeleteVRouter(s *ContrailTypeLogicService) {
	updateTestMockMetadataGetter(s)
	vmi := &models.VirtualMachineInterface{
		UUID: "2d9ebd36-709e-450a-8825-581997d06090",
		Name: "Base Mock",
	...
	writeService.EXPECT().DeleteVirtualRouterVirtualMachineRef(
		gomock.Not(gomock.Nil()), &services.DeleteVirtualRouterVirtualMachineRefRequest{
			ID: "5c40eeea-a8f9-4ef4-98b0-64c5b855222f",
			VirtualRouterVirtualMachineRef: &models.VirtualRouterVirtualMachineRef{
				UUID: "6e0f9d91-35af-4887-9932-adbcda4fbefa",
			},
		}).Times(1)
}

func updateTestMockAddVRouter(s *ContrailTypeLogicService) {
	updateTestMockMetadataGetter(s)
	vmi := &models.VirtualMachineInterface{
		UUID: "2d9ebd36-709e-450a-8825-581997d06090",
		Name: "Base Mock",
	...
	writeService := s.WriteService.(*servicesmock.MockWriteService) //nolint: errcheck
	writeService.EXPECT().CreateVirtualRouterVirtualMachineRef(
		gomock.Not(gomock.Nil()), &services.CreateVirtualRouterVirtualMachineRefRequest{
			ID: "5c40eeea-a8f9-4ef4-98b0-64c5b855222f",
			VirtualRouterVirtualMachineRef: &models.VirtualRouterVirtualMachineRef{
				UUID: "6e0f9d91-35af-4887-9932-adbcda4fbefa",
			},
...
func TestUpdateVRouterLinksVirtualMachineInterface(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedErr: "",
			mockSetUp: func(service *ContrailTypeLogicService) {
				updateTestMockVmiNoBindings(service)
			},
			statusCode: codes.OK,
		},
		{
		...
		{
			name: "proper binds but empty VirtualRouterRefs",
			requestVmi: &models.VirtualMachineInterface{
			...
			expectedErr: "",
			mockSetUp: func(service *ContrailTypeLogicService) {
				updateTestMockEmptyVRouterRefs(service)
			},
			statusCode: codes.OK,
		},
		{
			name: "check call of virtual router deletion function ",
			requestVmi: &models.VirtualMachineInterface{
				UUID: "cda17374-1385-4214-8d68-59d0f030838d",
			},
			databaseVmi: &models.VirtualMachineInterface{
			...
			expectedErr: "",
			mockSetUp: func(service *ContrailTypeLogicService) {
				updateTestMockDeleteVRouter(service)
			},
			statusCode: codes.OK,
		},
		{
			name: "check call of virtual router creation function ",
			requestVmi: &models.VirtualMachineInterface{
				UUID: "cda17374-1385-4214-8d68-59d0f030838d",
				VirtualMachineRefs: []*models.VirtualMachineInterfaceVirtualMachineRef{
					{
			...
			expectedErr: "",
			mockSetUp: func(service *ContrailTypeLogicService) {
				updateTestMockAddVRouter(service)
			},
			statusCode: codes.OK,
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.databaseVmi != nil {
				updateTestMockDatabaseVmi(service, tt.databaseVmi)
			}
