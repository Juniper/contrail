...
func (sv *ContrailTypeLogicService) validatePhysicalInterfaceDisplayName(
	...
	if err != nil {
		return errors.Wrapf(err, "failed to get physical interface parent router with uuid %s",
...
func (sv *ContrailTypeLogicService) validatePhysicalInterfaceESI(
	...
	norm, err := sv.validatePhysicalInterfaceESIStored(ctx, storedPhysicalInterface)
	if err != nil {
		return err
	}
...
func (sv *ContrailTypeLogicService) validatePhysicalInterfaceESIStored(
	ctx context.Context,
	storedPhysicalInterface *models.PhysicalInterface,
