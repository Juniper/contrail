...
const (
	// SubnetExhausted subnet is exhausted.
...
// AddressManager address management for virtual network
type AddressManager interface {
	// TODO: extend this interface with additionall methods if necessary.
	//		 Most likely following methos are going to be required:
