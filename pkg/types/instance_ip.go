...
func (sv *ContrailTypeLogicService) CreateInstanceIP(
	...
	err := sv.InTransactionDoer.DoInTransaction(
		...
		func(ctx context.Context) error {
			...
			var virtualRouterNetworkIpamRefs []*models.VirtualRouterNetworkIpamRef
			var instanceIPNetworkIpamRefs []*models.InstanceIPNetworkIpamRef
			...
			if virtualNetwork != nil {
				...
				instanceIPNetworkIpamRefs = networkIpamRefs
			}
