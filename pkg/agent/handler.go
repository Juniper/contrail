...
func newEventHandler() *eventHandler {
	return &eventHandler{
		clusterLog: logutil.NewFileLogger("agent-event-handler", "/var/log/contrail/deploy.log"),
		cloudLog:   logutil.NewFileLogger("agent-event-handler", "/var/log/contrail/cloud.log"),
	}
}
