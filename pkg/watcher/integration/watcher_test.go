...
func TestWatcherSynchronizesDataToEtcdUsingJSONStorage(t *testing.T) {
	...
	givenRunningWatcher(t, watcher.StorageJSON)
...
//	t.Skip("Not implemented") //TODO(daniel): finish implementation
//	e := clients.NewEtcd(t)
...
func givenRunningWatcher(t *testing.T, storage string) {
	err := watcher.Run(&watcher.Config{
