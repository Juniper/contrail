...
func (c *postgresReplicationConnection) GetReplicationSlot(name string) (maxWal uint64, snapshotName string, err error) {
...
func (c *postgresReplicationConnection) WaitForReplicationMessage(ctx context.Context) (*pgx.ReplicationMessage, error) {
