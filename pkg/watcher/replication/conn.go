...
// Conn overlays postgres connection and replication connection providing methods for replication management.
type Conn struct {
	replConn replConn
	conn     pgConn
}

// NewConn creates Conn with initialized connections.
