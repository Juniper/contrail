...
func (fip *Floatingip) Create(
	...
	return floatingipVncToNeutron(response.GetFloatingIP()), nil
}

func (fip *Floatingip) Read(
	context.Context, RequestParameters, string,
) (Response, error) {
	return nil, nil
}
...
func floatingipVncToNeutron(fIP *models.FloatingIP) *FloatingipResponse {
	return nil
}
