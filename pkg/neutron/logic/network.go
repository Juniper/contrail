...
func (n *Network) collectVirtualNetworks(
	...
	if len(filters) > 0 && filters.HasKeys(idKey) {
...
func collectFilteredAdminNetworks(
	...
	if filters.HasKeys(tenantIDKey) {
...
func collectUsingTenantID(
	...
	if filters.HasKeys(routerExternalKey) {
		req.ParentID = ""
