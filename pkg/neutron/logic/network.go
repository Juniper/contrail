...
func collectFilteredAdminNetworks(
	ctx context.Context, rp RequestParameters, filters Filters) ([]*models.VirtualNetwork, error,
) {
...
func collectSharedOrRouterExtNetworks(
	ctx context.Context, rp RequestParameters, filters Filters, req *listReq) ([]*models.VirtualNetwork, error,
) {
...
func checkIfVNMatchFilters(rp RequestParameters, filters Filters, vn *models.VirtualNetwork) bool {
	...
	if !checkFilterValue(filters, neutronNameKey, vn.GetName()) &&
		!checkFilterValue(filters, neutronNameKey, vn.GetDisplayName()) {
		return false
	}
...
func convertVNsToNeutronResponse(
	ctx context.Context, rp RequestParameters, filters Filters, vns []*models.VirtualNetwork,
) Response {
