...
func (r *NetworkResponse) setResponseRefs(vn *neutron.VirtualNetwork, policyRefs bool) {
	if refs := vn.GetNetworkPolicyRefs() != nil; policyRefs && refs != nil {
