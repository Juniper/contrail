...
func TestPortUpdate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			mask: types.FieldMask{
				Paths: []string{
					"data.resource." + MaskPortFieldName,
					"data.resource." + MaskPortFieldID,
					"data.resource." + MaskPortFieldDeviceID,
					"data.resource." + MaskPortFieldBindingHostID,
					"data.resource." + MaskPortFieldDeviceOwner,
				},
			},
			id: "b6283c9b-07ec-4061-941e-3f392844059f",
			expected: &PortResponse{
