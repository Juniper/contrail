...
func (port *Port) Create(ctx context.Context, rp RequestParameters) (Response, error) {
	...
	// if mac-address is specified, check against the existing ports
...
func (port *Port) Update(ctx context.Context, rp RequestParameters, id string) (Response, error) {
	...
	if err != nil {
		return nil, NewNeutronError(PortNotFound, map[string]interface{}{
			"port_id": id,
		})
	}
...
func (port *Port) Delete(ctx context.Context, rp RequestParameters, id string) (Response, error) {
	...
	if len(vmi.GetLogicalRouterBackRefs()) > 0 {
		return nil, NewNeutronError(L3PortInUse, map[string]interface{}{
			"port_id":      id,
...
func (port *Port) readVNCPort(
	...
	if err != nil {
		return nil, nil, NewNeutronError(BadRequest, map[string]interface{}{
			"resource": "port",
			"msg":      err.Error(),
		})
	}
	...
	if err != nil && errutil.IsNotFound(err) {
		return nil, nil, NewNeutronError("NetworkNotFound", map[string]interface{}{
			"net_id": id,
		})
	} else if err != nil {
		return nil, nil, err
...
func (port *Port) createInstanceIP(
	...
	if err != nil {
		...
		return nil, NewNeutronError(errorName, map[string]interface{}{
			"resource": "port",
			"msg":      err.Error(),
		})
	}
...
func (port *Port) getVirtualNetwork(
	...
	if err != nil {
		return nil, NewNeutronError("NetworkNotFound", map[string]interface{}{
...
func (port *Port) setVMInstance(ctx context.Context, rp RequestParameters,
	...
	if err != nil {
		return NewNeutronError(BadRequest, map[string]interface{}{
			"resource": "port",
			"msg":      err.Error(),
		})
	}
...
func (port *Port) setPortSecurity(
	...
	if err != nil && errutil.IsNotFound(err) {
		...
		return NewNeutronError("SecurityGroupNotFound", map[string]interface{}{
			"device_owner": "network:router_interface",
		})
	} else if err != nil {
		return err
...
func (port *Port) setBindings(vmi *models.VirtualMachineInterface) {
	setBinding := func(key string, value string) {
	...
	if port.BindingVnicType != "" {
		setBinding("vnic_type", port.BindingVnicType)
	}
	if port.BindingVifType != "" {
		setBinding("vif_type", port.BindingVifType)
	}
	if port.BindingHostID != "" {
		setBinding("host_id", port.BindingHostID)
	}
}
...
func (port *Port) checkMacAddress(ctx context.Context, rp RequestParameters) error {
	...
	if res.GetVirtualMachineInterfaceCount() != 0 {
		return NewNeutronError("MacAddressInUse", map[string]interface{}{
			"net_id": port.NetworkID,
			"mac":    port.MacAddress,
		})
	}
