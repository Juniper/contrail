...
const (
	...
	// TODO(ignacy.osetek) Handle _apply_subnet_host_routes variable from neutron_plugin_db.py
	applySubnetHostRoutes = true
)
...
func locateInterfaceRouteTableWithSubnet(
	...
	irtName := getInterfaceRouteTableName(subnetUUID, vmi.GetUUID())
	irtFQName := append(vmi.GetFQName(), irtName)
