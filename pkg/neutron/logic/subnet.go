...
func (s *Subnet) portUpdateIfaceRouteTable(
	vn *models.VirtualNetwork, subnetCIDR string, subnetID string, newHR []*RouteTableType, oldHR []*RouteTableType, rp RequestParameters,
) error {
	...
	// Czy to request contexst będzie?
	IPsResponse, _ := rp.ReadService.ListInstanceIP(rp.RequestContext, &services.ListInstanceIPRequest{
