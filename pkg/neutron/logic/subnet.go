...
func (s *Subnet) Create(ctx context.Context, rp RequestParameters) (Response, error) {
	...
	return s.makeResponse(virtualNetwork)
}

func (s *Subnet) makeResponse(virtualNetwork *models.VirtualNetwork) (*SubnetResponse, error) {
	...
	return nil, errors.Errorf(
		"subnet '%s' create failed for virtual network: '%s'",
		s.Cidr, virtualNetwork.GetUUID(),
	)
}
