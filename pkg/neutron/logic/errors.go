...
const (
	...
	securityGroupRuleParameterConflict        = "SecurityGroupRuleParameterConflict"
	securityGroupRuleInvalidProtocol          = "SecurityGroupRuleInvalidProtocol"
	securityGroupRuleExists                   = "SecurityGroupRuleExists"
