...
func (sgr *SecurityGroupRule) getIPPrefixWithLen() (string, int64, error) {
	...
	if sgr.RemoteIPPrefix == emptyAddressIPv4withMask {
		return emptyAddressIPv4, 0, nil
	}

	if sgr.RemoteIPPrefix == emptyAddressIPv6withMask {
		return emptyAddressIPv6, 0, nil
	}
