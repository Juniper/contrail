...
const (
	...
	emptyAddressIPv4withMask      = "0.0.0.0/0"
	emptyAddressIPv6withMask      = "::/0"
	defaultPortMin                = 0
...
func getDefaultSecurityGroupRuleIPv4() *SecurityGroupRule {
	...
	sgr.RemoteIPPrefix = emptyAddressIPv4withMask
	return sgr
}
...
func getDefaultSecurityGroupRuleIPv6() *SecurityGroupRule {
	...
	sgr.RemoteIPPrefix = emptyAddressIPv6withMask
	return sgr
}

func securityGroupRuleNeutronFromVnc(
...
func (sgr *SecurityGroupRule) vncFromNeutron(ctx context.Context, rp RequestParameters,
...
func (sgr SecurityGroupRule) initAddressType(ctx context.Context, rp RequestParameters, vncSgr *models.PolicyRuleType,
) error {
...
func (sgr SecurityGroupRule) getIPPrefixWithLen() (string, int64, error) {
	...
	if err != nil {
		return "", 0, errors.Wrapf(err, "can't determinate ip version of the IP: "+sgr.RemoteIPPrefix)
	}
	...
	return getIPPrefixAndPrefixLen(sgr.RemoteIPPrefix)
}
...
func securityGroupRuleCreate(
	...
	if err != nil {
		// TODO: When implementing Security Group Rule - create write test to this errors.
