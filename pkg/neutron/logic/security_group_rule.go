...
func (sgr *SecurityGroupRule) getGenericDefaultSecurityGroupRule() {
...
func (sgr *SecurityGroupRule) getDefaultSecurityGroupRuleIPv4() {
	sgr.getGenericDefaultSecurityGroupRule()
	sgr.Ethertype = ethertypeIPv4
	sgr.RemoteIPPrefix = emptyadressIPv4withMask
}

func (sgr *SecurityGroupRule) getDefaultSecurityGroupRuleIPv6() {
	sgr.getGenericDefaultSecurityGroupRule()
