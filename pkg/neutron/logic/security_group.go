...
func (sg *SecurityGroup) Create(ctx context.Context, rp RequestParameters) (Response, error) {
	...
	if err != nil {
		return nil, newSecurityGroupRuleError(err, "can't cast security_group_rule into contrail resource")
	}
	securityGroupRuleCreate(contrailSecurityGroup, contrailRuleIPv4)
...
func (sg *SecurityGroup) ReadAll(ctx context.Context, rp RequestParameters, f Filters, fields Fields) (
	...
	if err != nil {
		return nil, newSecurityGroupError(err, "error while processing default security_group. ") // TODO maybe this is not needed. See if deeper function are wrapping properly errors
	}
...
func writeContrailSecurityGroup(ctx context.Context,
