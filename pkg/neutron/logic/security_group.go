...
func securityGroupVNCToNeutron(ctx Context, sg *models.SecurityGroup, operation string) Response {
...
func readSecurityGroupRules(ctx Context) ([]*security_group_rule, error) {
	// TODO: implement it
