...
func TestSecurityGroup(t *testing.T) {
    ...
    mutexTable := common.UseTable(db, "security_group")
    mutexProject := common.UseTable(db, "security_group")
    defer func(){
        mutexTable.Unlock()
...
//
    err = common.DoInTransaction(db, func (tx *sql.Tx) error {
        return CreateSecurityGroup(ctx, tx, 
...
//    
    ...
    err = common.DoInTransaction(db, func (tx *sql.Tx) error {
        response, err := ListSecurityGroup(ctx, tx, &models.ListSecurityGroupRequest{
    ...
    err = common.DoInTransaction(db, func (tx *sql.Tx) error {
        return DeleteSecurityGroup(ctxDemo, tx, 
