...
func CreateVirtualDNSRecord(tx *sql.Tx, model *models.VirtualDNSRecord) error {
	...
	_, err = stmt.Exec(int(model.VirtualDNSRecordData.RecordTTLSeconds),
