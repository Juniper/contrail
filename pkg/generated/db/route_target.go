...
const insertRouteTargetQuery = "insert into `route_target` (`display_name`,`key_value_pair`,`owner`,`owner_access`,`global_access`,`share`,`uuid`,`fq_name`,`user_visible`,`last_modified`,`group_access`,`permissions_owner`,`permissions_owner_access`,`other_access`,`group`,`enable`,`description`,`created`,`creator`) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);"
const updateRouteTargetQuery = "update `route_target` set `display_name` = ?,`key_value_pair` = ?,`owner` = ?,`owner_access` = ?,`global_access` = ?,`share` = ?,`uuid` = ?,`fq_name` = ?,`user_visible` = ?,`last_modified` = ?,`group_access` = ?,`permissions_owner` = ?,`permissions_owner_access` = ?,`other_access` = ?,`group` = ?,`enable` = ?,`description` = ?,`created` = ?,`creator` = ?;"
...
func ListRouteTarget(tx *sql.Tx, spec *db.ListSpec) ([]*models.RouteTarget, error) {
	var rows *sql.Rows
	var err error
	//TODO (check input)
...
func ShowRouteTarget(tx *sql.Tx, uuid string) (*models.RouteTarget, error) {
	list, err := ListRouteTarget(tx, &db.ListSpec{
