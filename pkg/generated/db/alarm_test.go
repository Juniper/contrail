...
func TestAlarm(t *testing.T) {
	...
	mutexTable := common.UseTable(db.DB, "alarm")
	// mutexProject := common.UseTable(db.DB, "alarm")
	defer func() {
		mutexTable.Unlock()
	...
	response, err := db.ListAlarm(ctx, &models.ListAlarmRequest{
