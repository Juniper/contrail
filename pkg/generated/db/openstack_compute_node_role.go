...
func CreateOpenstackComputeNodeRole(
	ctx context.Context,
	tx *sql.Tx,
	request *models.CreateOpenstackComputeNodeRoleRequest) error {
	...
	err = common.CreateSharing(tx, "openstack_compute_node_role", model.UUID, model.GetPerms2().GetShare())
	if err != nil {
		return err
	}
	log.WithFields(log.Fields{
...
func ListOpenstackComputeNodeRole(ctx context.Context, tx *sql.Tx, request *models.ListOpenstackComputeNodeRoleRequest) (response *models.ListOpenstackComputeNodeRoleResponse, err error) {
	var rows *sql.Rows
	qb := &common.ListQueryBuilder{}
	qb.Auth = common.GetAuthCTX(ctx)
	spec := request.Spec
	qb.Spec = spec
	qb.Table = "openstack_compute_node_role"
	qb.Fields = OpenstackComputeNodeRoleFields
	qb.RefFields = OpenstackComputeNodeRoleRefFields
	qb.BackRefFields = OpenstackComputeNodeRoleBackRefFields
	result := []*models.OpenstackComputeNodeRole{}
	...
	response = &models.ListOpenstackComputeNodeRoleResponse{
		OpenstackComputeNodeRoles: result,
	}
	return response, nil
}

// UpdateOpenstackComputeNodeRole updates a resource
func UpdateOpenstackComputeNodeRole(
	ctx context.Context,
	tx *sql.Tx,
...
func DeleteOpenstackComputeNodeRole(
	ctx context.Context,
	tx *sql.Tx,
	request *models.DeleteOpenstackComputeNodeRoleRequest) error {
