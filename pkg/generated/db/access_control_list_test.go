...
func TestAccessControlList(t *testing.T) {
	...
	if ".AccessControlListHash" == ".Perms2.Share" {
		var share []interface{}
		share = append(share, map[string]interface{}{"tenant": "default-domain-test:admin-test", "tenant_access": 7})
		common.SetValueByPath(updateMap, ".AccessControlListHash", ".", share)
	} else {
		common.SetValueByPath(updateMap, ".AccessControlListHash", ".", `{"test": "test"}`)
	}
