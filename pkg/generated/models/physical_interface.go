...
type PhysicalInterface struct {
	...
	PhysicalInterfaceRefs []*PhysicalInterfacePhysicalInterfaceRef

	PhysicalRouters []*PhysicalInterfacePhysicalRouter
}
...
// PhysicalInterface parents relation object

type PhysicalInterfacePhysicalRouter struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN
...
func InterfaceToPhysicalInterface(iData interface{}) *PhysicalInterface {
	...
	return &PhysicalInterface{
		...
		//{"Title":"","Description":"Ethernet Segment Id configured for the Physical Interface. In a multihomed environment, user should configure the peer Physical interface with the same ESI.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"ethernet_segment_identifier","Item":null,"GoName":"EthernetSegmentIdentifier","GoType":"string","GoPremitive":true}
