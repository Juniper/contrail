...
type E2ServiceProvider struct {
	...
	PhysicalRouterRefs []*E2ServiceProviderPhysicalRouterRef
	// peering_policy <utils.Reference Value>
	PeeringPolicyRefs []*E2ServiceProviderPeeringPolicyRef
}
...
func InterfaceToE2ServiceProvider(iData interface{}) *E2ServiceProvider {
	...
	return &E2ServiceProvider{
		...
		//{"Title":"","Description":"This service provider is connected to all other service providers.","SQL":"bool","Default":null,"Operation":"","Presence":"optional","Type":"boolean","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"e2_service_provider_promiscuous","Item":null,"GoName":"E2ServiceProviderPromiscuous","GoType":"bool"}
