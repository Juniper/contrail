...
func InterfaceToKubernetesCluster(iData interface{}) *KubernetesCluster {
	...
	return &KubernetesCluster{
		...
		//{"Title":"Contrail Cluster ID","Description":"","SQL":"varchar(255)","Default":"","Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"contrail_cluster_id","Item":null,"GoName":"ContrailClusterID","GoType":"string"}
		KuberunetesDashboard: data["kuberunetes_dashboard"].(string),

		//{"Title":"kubernetes Dashboard","Description":"","SQL":"varchar(255)","Default":"","Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"kuberunetes_dashboard","Item":null,"GoName":"KuberunetesDashboard","GoType":"string"}
