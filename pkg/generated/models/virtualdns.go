...
type VirtualDNS struct {
	...
	Domains []*VirtualDNSDomain
}

// VirtualDNS parents relation object

type VirtualDNSDomain struct {
	UUID string   `json:"uuid"`
