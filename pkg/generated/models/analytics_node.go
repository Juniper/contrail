...
type AnalyticsNode struct {
	...
	GlobalSystemConfigs []*AnalyticsNodeGlobalSystemConfig
}

// AnalyticsNode parents relation object

type AnalyticsNodeGlobalSystemConfig struct {
	UUID string   `json:"uuid"`
...
func InterfaceToAnalyticsNode(iData interface{}) *AnalyticsNode {
	...
	return &AnalyticsNode{
		...
		//{"Title":"","Description":"Ip address of the analytics node, set while provisioning.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"admin-only","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/IpAddressType","CollectionType":"","Column":"analytics_node_ip_address","Item":null,"GoName":"AnalyticsNodeIPAddress","GoType":"IpAddressType","GoPremitive":false}
