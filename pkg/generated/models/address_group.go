...
type AddressGroup struct {
	...
	Projects          []*AddressGroupProject
	PolicyManagements []*AddressGroupPolicyManagement
}

// AddressGroup parents relation object

type AddressGroupPolicyManagement struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN

}

type AddressGroupProject struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN
...
func InterfaceToAddressGroup(iData interface{}) *AddressGroup {
	...
	return &AddressGroup{
		...
		//{"Title":"","Description":"List of IP prefix","SQL":"text","Default":null,"Operation":"","Presence":"optional","Type":"object","Permission":null,"Properties":{"subnet":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"array","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"","Item":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"object","Permission":null,"Properties":{"ip_prefix":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"","Item":null,"GoName":"IPPrefix","GoType":"string","GoPremitive":true},"ip_prefix_len":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"","Item":null,"GoName":"IPPrefixLen","GoType":"int","GoPremitive":true}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/SubnetType","CollectionType":"","Column":"","Item":null,"GoName":"Subnet","GoType":"SubnetType","GoPremitive":false},"GoName":"Subnet","GoType":"[]*SubnetType","GoPremitive":true}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/SubnetListType","CollectionType":"list","Column":"address_group_prefix","Item":null,"GoName":"AddressGroupPrefix","GoType":"SubnetListType","GoPremitive":false}
