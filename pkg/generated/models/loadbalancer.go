...
type Loadbalancer struct {
	...
	ServiceApplianceSetRefs []*LoadbalancerServiceApplianceSetRef
	// virtual_machine_interface <utils.Reference Value>
	VirtualMachineInterfaceRefs []*LoadbalancerVirtualMachineInterfaceRef
	// service_instance <utils.Reference Value>
	ServiceInstanceRefs []*LoadbalancerServiceInstanceRef
