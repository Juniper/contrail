...
type VirtualDNSRecord struct {
	...
	VirtualDNSs []*VirtualDNSRecordVirtualDNS
}

// VirtualDNSRecord parents relation object

type VirtualDNSRecordVirtualDNS struct {
	UUID string   `json:"uuid"`
...
func InterfaceToVirtualDNSRecord(iData interface{}) *VirtualDNSRecord {
	...
	return &VirtualDNSRecord{
		...
		//{"Title":"","Description":"DNS record data has configuration like type, name, ip address, loadbalancing etc.","SQL":"","Default":null,"Operation":"","Presence":"required","Type":"object","Permission":null,"Properties":{"record_class":{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":{},"Enum":["IN"],"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/DnsRecordClassType","CollectionType":"","Column":"record_class","Item":null,"GoName":"RecordClass","GoType":"DnsRecordClassType","GoPremitive":false},"record_data":{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"true","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"record_data","Item":null,"GoName":"RecordData","GoType":"string","GoPremitive":true},"record_mx_preference":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"record_mx_preference","Item":null,"GoName":"RecordMXPreference","GoType":"int","GoPremitive":true},"record_name":{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"true","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"record_name","Item":null,"GoName":"RecordName","GoType":"string","GoPremitive":true},"record_ttl_seconds":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"record_ttl_seconds","Item":null,"GoName":"RecordTTLSeconds","GoType":"int","GoPremitive":true},"record_type":{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":{},"Enum":["A","AAAA","CNAME","PTR","NS","MX"],"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/DnsRecordTypeType","CollectionType":"","Column":"record_type","Item":null,"GoName":"RecordType","GoType":"DnsRecordTypeType","GoPremitive":false}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/VirtualDnsRecordType","CollectionType":"","Column":"","Item":null,"GoName":"VirtualDNSRecordData","GoType":"VirtualDnsRecordType","GoPremitive":false}
