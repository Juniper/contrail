...
type Tag struct {
	...
	// tag_type <utils.Reference Value>
	TagTypeRefs []*TagTagTypeRef

	Projects    []*TagProject
	ConfigRoots []*TagConfigRoot
}
...
func InterfaceToTag(iData interface{}) *Tag {
	...
	return &Tag{
		...
		//{"Title":"","Description":"Internal Tag ID encapsulating tag type and value in                  hexadecimal fomat: 0xTTTTVVVV (T: type, V: value)","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/U32BitHexInt","CollectionType":"","Column":"tag_id","Item":null,"GoName":"TagID","GoType":"U32BitHexInt","GoPremitive":false}
		...
		//{"Title":"","Description":"Tag type string representation","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"tag_type_name","Item":null,"GoName":"TagTypeName","GoType":"string","GoPremitive":true}
		TagValue: data["tag_value"].(string),

		//{"Title":"","Description":"Tag value string representation","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"tag_value","Item":null,"GoName":"TagValue","GoType":"string","GoPremitive":true}
