...
type GlobalQosConfig struct {
	...
	GlobalSystemConfigs []*GlobalQosConfigGlobalSystemConfig
}

// GlobalQosConfig parents relation object

type GlobalQosConfigGlobalSystemConfig struct {
	UUID string   `json:"uuid"`
...
func InterfaceToGlobalQosConfig(iData interface{}) *GlobalQosConfig {
	...
	return &GlobalQosConfig{
		...
		//{"Title":"","Description":"DSCP value of IP header for control traffic","SQL":"","Default":null,"Operation":"","Presence":"required","Type":"object","Permission":null,"Properties":{"analytics":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":0,"Maximum":63,"Ref":"types.json#/definitions/DscpValueType","CollectionType":"","Column":"analytics","Item":null,"GoName":"Analytics","GoType":"DscpValueType","GoPremitive":false},"control":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":0,"Maximum":63,"Ref":"types.json#/definitions/DscpValueType","CollectionType":"","Column":"control","Item":null,"GoName":"Control","GoType":"DscpValueType","GoPremitive":false},"dns":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":0,"Maximum":63,"Ref":"types.json#/definitions/DscpValueType","CollectionType":"","Column":"dns","Item":null,"GoName":"DNS","GoType":"DscpValueType","GoPremitive":false}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/ControlTrafficDscpType","CollectionType":"","Column":"","Item":null,"GoName":"ControlTrafficDSCP","GoType":"ControlTrafficDscpType","GoPremitive":false}
