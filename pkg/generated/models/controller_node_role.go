...
// ControllerNodeRole parents relation object
...
func InterfaceToControllerNodeRole(iData interface{}) *ControllerNodeRole {
	...
	return &ControllerNodeRole{
		...
		//{"Title":"Storage Management  Bond Interface Members","Description":"Storage Management  Bond Interface Members","SQL":"varchar(255)","Default":"ens8f0,ens8f1","Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"storage_management_bond_interface_members","Item":null,"GoName":"StorageManagementBondInterfaceMembers","GoType":"string","GoPremitive":true}
		...
		//{"Title":"Capacity Drives","Description":"Drives for capacity oriented applications such as logging","SQL":"varchar(255)","Default":"sdc,sdd,sde","Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"capacity_drives","Item":null,"GoName":"CapacityDrives","GoType":"string","GoPremitive":true}
		InternalapiBondInterfaceMembers: data["internalapi_bond_interface_members"].(string),

		//{"Title":"Internal API Bond Interface Members","Description":"Internal API Bond Interface Members","SQL":"varchar(255)","Default":"ens7f0,ens7f1","Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"internalapi_bond_interface_members","Item":null,"GoName":"InternalapiBondInterfaceMembers","GoType":"string","GoPremitive":true}
		PerformanceDrives: data["performance_drives"].(string),

		//{"Title":"Performance Drive","Description":"Drives for performance oriented application such as journaling","SQL":"varchar(255)","Default":"sdf","Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"performance_drives","Item":null,"GoName":"PerformanceDrives","GoType":"string","GoPremitive":true}
