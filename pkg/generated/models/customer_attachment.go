...
type CustomerAttachment struct {
	...
	VirtualMachineInterfaceRefs []*CustomerAttachmentVirtualMachineInterfaceRef
	// floating_ip <utils.Reference Value>
	FloatingIPRefs []*CustomerAttachmentFloatingIPRef
}
...
// CustomerAttachment parents relation object
