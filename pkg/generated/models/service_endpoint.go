...
type ServiceEndpoint struct {
	...
	PhysicalRouterRefs []*ServiceEndpointPhysicalRouterRef
	// service_object <utils.Reference Value>
	ServiceObjectRefs []*ServiceEndpointServiceObjectRef
	// service_connection_module <utils.Reference Value>
	ServiceConnectionModuleRefs []*ServiceEndpointServiceConnectionModuleRef
}
