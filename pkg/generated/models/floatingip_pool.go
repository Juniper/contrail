...
type FloatingIPPool struct {
	...
	VirtualNetworks []*FloatingIPPoolVirtualNetwork
}

// FloatingIPPool parents relation object

type FloatingIPPoolVirtualNetwork struct {
	UUID string   `json:"uuid"`
...
func InterfaceToFloatingIPPool(iData interface{}) *FloatingIPPool {
	...
	return &FloatingIPPool{
		...
		//{"Title":"","Description":"Subnets that restrict floating ip allocation from the corresponding virtual network.","SQL":"","Default":null,"Operation":"","Presence":"optional","Type":"object","Permission":null,"Properties":{"subnet_uuid":{"Title":"","Description":"","SQL":"text","Default":null,"Operation":"","Presence":"","Type":"array","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"subnet_uuid","Item":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"","Item":null,"GoName":"SubnetUUID","GoType":"string","GoPremitive":true},"GoName":"SubnetUUID","GoType":"[]string","GoPremitive":true}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/FloatingIpPoolSubnetType","CollectionType":"","Column":"","Item":null,"GoName":"FloatingIPPoolSubnets","GoType":"FloatingIpPoolSubnetType","GoPremitive":false}
