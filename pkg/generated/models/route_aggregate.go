...
type RouteAggregate struct {
	...
	ServiceInstanceRefs []*RouteAggregateServiceInstanceRef

	Projects []*RouteAggregateProject
}
...
// RouteAggregate parents relation object

type RouteAggregateProject struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN
