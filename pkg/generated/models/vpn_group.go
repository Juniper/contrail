...
// VPNGroup parents relation object
...
func InterfaceToVPNGroup(iData interface{}) *VPNGroup {
	...
	return &VPNGroup{
		...
		//{"Title":"VPN Type","Description":"Type of VPN","SQL":"varchar(255)","Default":"ipsec","Operation":"","Presence":"","Type":"string","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"type","Item":null,"GoName":"Type","GoType":"string","GoPremitive":true}
