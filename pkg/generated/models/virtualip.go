...
type VirtualIP struct {
	...
	// loadbalancer_pool <utils.Reference Value>
	LoadbalancerPoolRefs []*VirtualIPLoadbalancerPoolRef
	// virtual_machine_interface <utils.Reference Value>
	VirtualMachineInterfaceRefs []*VirtualIPVirtualMachineInterfaceRef
