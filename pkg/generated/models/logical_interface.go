...
type LogicalInterface struct {
	...
	VirtualMachineInterfaceRefs []*LogicalInterfaceVirtualMachineInterfaceRef

	PhysicalRouters    []*LogicalInterfacePhysicalRouter
	PhysicalInterfaces []*LogicalInterfacePhysicalInterface
}
...
// LogicalInterface parents relation object

type LogicalInterfacePhysicalRouter struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN

}

type LogicalInterfacePhysicalInterface struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN
...
func InterfaceToLogicalInterface(iData interface{}) *LogicalInterface {
	...
	return &LogicalInterface{
		...
		//{"Title":"","Description":"VLAN tag (.1Q) classifier for this logical interface.","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"logical_interface_vlan_tag","Item":null,"GoName":"LogicalInterfaceVlanTag","GoType":"int","GoPremitive":true}
		LogicalInterfaceType: InterfaceToLogicalInterfaceType(data["logical_interface_type"]),

		//{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":{},"Enum":["l2","l3"],"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/LogicalInterfaceType","CollectionType":"","Column":"logical_interface_type","Item":null,"GoName":"LogicalInterfaceType","GoType":"LogicalInterfaceType","GoPremitive":false}
