...
type AliasIP struct {
	...
	VirtualMachineInterfaceRefs []*AliasIPVirtualMachineInterfaceRef
	// project <utils.Reference Value>
	ProjectRefs []*AliasIPProjectRef

	AliasIPPools []*AliasIPAliasIPPool
}
...
// AliasIP parents relation object

type AliasIPAliasIPPool struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN
...
func InterfaceToAliasIP(iData interface{}) *AliasIP {
	...
	return &AliasIP{
		...
		//{"Title":"","Description":"Alias ip address.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/IpAddressType","CollectionType":"","Column":"alias_ip_address","Item":null,"GoName":"AliasIPAddress","GoType":"IpAddressType","GoPremitive":false}
		AliasIPAddressFamily: InterfaceToIpAddressFamilyType(data["alias_ip_address_family"]),

		//{"Title":"","Description":"Ip address family of the alias ip, IpV4 or IpV6","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":{},"Enum":["v4","v6"],"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/IpAddressFamilyType","CollectionType":"","Column":"alias_ip_address_family","Item":null,"GoName":"AliasIPAddressFamily","GoType":"IpAddressFamilyType","GoPremitive":false}
