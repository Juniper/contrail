...
func InterfaceToAliasIP(iData interface{}) *AliasIP {
	...
	return &AliasIP{
		...
		//{"Title":"","Description":"Alias ip address.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/IpAddressType","CollectionType":"","Column":"alias_ip_address","Item":null,"GoName":"AliasIPAddress","GoType":"IpAddressType"}
