...
type DatabaseNode struct {
	...
	GlobalSystemConfigs []*DatabaseNodeGlobalSystemConfig
}

// DatabaseNode parents relation object

type DatabaseNodeGlobalSystemConfig struct {
	UUID string   `json:"uuid"`
...
func InterfaceToDatabaseNode(iData interface{}) *DatabaseNode {
	...
	return &DatabaseNode{
		...
		//{"Title":"","Description":"Ip address of the database node, set while provisioning.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/IpAddressType","CollectionType":"","Column":"database_node_ip_address","Item":null,"GoName":"DatabaseNodeIPAddress","GoType":"IpAddressType","GoPremitive":false}
