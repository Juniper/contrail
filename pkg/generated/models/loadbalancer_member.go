...
type LoadbalancerMember struct {
	...
	LoadbalancerPools []*LoadbalancerMemberLoadbalancerPool
}

// LoadbalancerMember parents relation object

type LoadbalancerMemberLoadbalancerPool struct {
	UUID string   `json:"uuid"`
...
func InterfaceToLoadbalancerMember(iData interface{}) *LoadbalancerMember {
	...
	return &LoadbalancerMember{
		...
		//{"Title":"","Description":"Member configuration like ip address, destination port, weight etc.","SQL":"","Default":null,"Operation":"","Presence":"required","Type":"object","Permission":null,"Properties":{"address":{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/IpAddressType","CollectionType":"","Column":"address","Item":null,"GoName":"Address","GoType":"IpAddressType","GoPremitive":false},"admin_state":{"Title":"","Description":"","SQL":"bool","Default":null,"Operation":"","Presence":"optional","Type":"boolean","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"admin_state","Item":null,"GoName":"AdminState","GoType":"bool","GoPremitive":true},"protocol_port":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"protocol_port","Item":null,"GoName":"ProtocolPort","GoType":"int","GoPremitive":true},"status":{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"system-only","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"status","Item":null,"GoName":"Status","GoType":"string","GoPremitive":true},"status_description":{"Title":"","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"system-only","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"status_description","Item":null,"GoName":"StatusDescription","GoType":"string","GoPremitive":true},"weight":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"weight","Item":null,"GoName":"Weight","GoType":"int","GoPremitive":true}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/LoadbalancerMemberType","CollectionType":"","Column":"","Item":null,"GoName":"LoadbalancerMemberProperties","GoType":"LoadbalancerMemberType","GoPremitive":false}
