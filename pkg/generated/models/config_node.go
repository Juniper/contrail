...
type ConfigNode struct {
	...
	GlobalSystemConfigs []*ConfigNodeGlobalSystemConfig
}

// ConfigNode parents relation object

type ConfigNodeGlobalSystemConfig struct {
	UUID string   `json:"uuid"`
...
func InterfaceToConfigNode(iData interface{}) *ConfigNode {
	...
	return &ConfigNode{
		...
		//{"Title":"","Description":"Ip address of the config node, set while provisioning.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"admin-only","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/IpAddressType","CollectionType":"","Column":"config_node_ip_address","Item":null,"GoName":"ConfigNodeIPAddress","GoType":"IpAddressType","GoPremitive":false}
