...
type FirewallPolicy struct {
	...
	// firewall_rule <utils.Reference Value>
	FirewallRuleRefs []*FirewallPolicyFirewallRuleRef
	// security_logging_object <utils.Reference Value>
	SecurityLoggingObjectRefs []*FirewallPolicySecurityLoggingObjectRef

	Projects          []*FirewallPolicyProject
	PolicyManagements []*FirewallPolicyPolicyManagement
}
...
// FirewallPolicy parents relation object

type FirewallPolicyProject struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN

}

type FirewallPolicyPolicyManagement struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN
