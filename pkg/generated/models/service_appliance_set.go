...
type ServiceApplianceSet struct {
	...
	GlobalSystemConfigs []*ServiceApplianceSetGlobalSystemConfig
}

// ServiceApplianceSet parents relation object

type ServiceApplianceSetGlobalSystemConfig struct {
	UUID string   `json:"uuid"`
...
func InterfaceToServiceApplianceSet(iData interface{}) *ServiceApplianceSet {
	...
	return &ServiceApplianceSet{
		...
		//{"Title":"","Description":"List of Key:Value pairs that are used by the provider driver and opaque to system.","SQL":"","Default":null,"Operation":"","Presence":"optional","Type":"object","Permission":null,"Properties":{"key_value_pair":{"Title":"","Description":"","SQL":"text","Default":null,"Operation":"","Presence":"","Type":"array","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"key_value_pair","Item":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"object","Permission":null,"Properties":{"key":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"","Item":null,"GoName":"Key","GoType":"string","GoPremitive":true},"value":{"Title":"","Description":"","SQL":"","Default":null,"Operation":"","Presence":"","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"","Item":null,"GoName":"Value","GoType":"string","GoPremitive":true}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/KeyValuePair","CollectionType":"","Column":"","Item":null,"GoName":"KeyValuePair","GoType":"KeyValuePair","GoPremitive":false},"GoName":"KeyValuePair","GoType":"[]*KeyValuePair","GoPremitive":true}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/KeyValuePairs","CollectionType":"","Column":"","Item":null,"GoName":"ServiceApplianceSetProperties","GoType":"KeyValuePairs","GoPremitive":false}
		ServiceApplianceHaMode: data["service_appliance_ha_mode"].(string),

		//{"Title":"","Description":"High availability mode for the service appliance set, active-active or active-backup.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"service_appliance_ha_mode","Item":null,"GoName":"ServiceApplianceHaMode","GoType":"string","GoPremitive":true}
		ServiceApplianceDriver: data["service_appliance_driver"].(string),

		//{"Title":"","Description":"Name of the provider driver for this service appliance set.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"optional","Type":"string","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"service_appliance_driver","Item":null,"GoName":"ServiceApplianceDriver","GoType":"string","GoPremitive":true}
