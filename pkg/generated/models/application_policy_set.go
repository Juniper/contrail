...
type ApplicationPolicySet struct {
	...
	// firewall_policy <utils.Reference Value>
	FirewallPolicyRefs []*ApplicationPolicySetFirewallPolicyRef
	// global_vrouter_config <utils.Reference Value>
	GlobalVrouterConfigRefs []*ApplicationPolicySetGlobalVrouterConfigRef

	Projects          []*ApplicationPolicySetProject
	PolicyManagements []*ApplicationPolicySetPolicyManagement
}
...
// ApplicationPolicySet parents relation object

type ApplicationPolicySetProject struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN

}

type ApplicationPolicySetPolicyManagement struct {
	UUID string   `json:"uuid"`
	To   []string `json:"to"` //FQDN
...
func InterfaceToApplicationPolicySet(iData interface{}) *ApplicationPolicySet {
	...
	return &ApplicationPolicySet{
		...
		//{"Title":"","Description":"If set, indicates application policy set to be applied to all application tags","SQL":"bool","Default":false,"Operation":"","Presence":"optional","Type":"boolean","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"all_applications","Item":null,"GoName":"AllApplications","GoType":"bool","GoPremitive":true}
