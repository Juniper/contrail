...
func InterfaceToWidget(iData interface{}) *Widget {
	...
	return &Widget{
		...
		//{"Title":"Content Config","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"content_config","Item":null,"GoName":"ContentConfig","GoType":"string"}
		LayoutConfig: data["layout_config"].(string),

		//{"Title":"Layout Config","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"layout_config","Item":null,"GoName":"LayoutConfig","GoType":"string"}
		...
		//{"Title":"Container Config","Description":"","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"","Type":"string","Permission":["create","update"],"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"container_config","Item":null,"GoName":"ContainerConfig","GoType":"string"}
