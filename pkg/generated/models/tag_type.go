...
// TagType parents relation object
...
func InterfaceToTagType(iData interface{}) *TagType {
	...
	return &TagType{
		...
		//{"Title":"","Description":"Internal Tag type ID                  coded on 16 bits where the first 255 IDs are reserved                  and pre-defined. Users (principally cloud admin) can define                  arbitrary types but its automatically shared to all project as                  it is a global resource.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/U16BitHexInt","CollectionType":"","Column":"tag_type_id","Item":null,"GoName":"TagTypeID","GoType":"U16BitHexInt","GoPremitive":false}
