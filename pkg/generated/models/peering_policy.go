...
// PeeringPolicy parents relation object
...
func InterfaceToPeeringPolicy(iData interface{}) *PeeringPolicy {
	...
	return &PeeringPolicy{
		...
		//{"Title":"","Description":"Peering policy service type.","SQL":"varchar(255)","Default":null,"Operation":"","Presence":"required","Type":"string","Permission":null,"Properties":{},"Enum":["public-peering"],"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/PeeringServiceType","CollectionType":"","Column":"peering_service","Item":null,"GoName":"PeeringService","GoType":"PeeringServiceType","GoPremitive":false}
