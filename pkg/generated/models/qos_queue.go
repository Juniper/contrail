...
func InterfaceToQosQueue(iData interface{}) *QosQueue {
	...
	return &QosQueue{
		...
		//{"Title":"","Description":"Maximum bandwidth for this queue.","SQL":"int","Default":null,"Operation":"","Presence":"required","Type":"integer","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"max_bandwidth","Item":null,"GoName":"MaxBandwidth","GoType":"int"}
		...
		//{"Title":"","Description":"Unique id for this queue.","SQL":"int","Default":null,"Operation":"","Presence":"required","Type":"integer","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"qos_queue_identifier","Item":null,"GoName":"QosQueueIdentifier","GoType":"int"}
		MinBandwidth: data["min_bandwidth"].(int),

		//{"Title":"","Description":"Minimum bandwidth for this queue.","SQL":"int","Default":null,"Operation":"","Presence":"required","Type":"integer","Permission":null,"Properties":null,"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"min_bandwidth","Item":null,"GoName":"MinBandwidth","GoType":"int"}
