...
type Domain struct {
	...
	ConfigRoots []*DomainConfigRoot
}

// Domain parents relation object

type DomainConfigRoot struct {
	UUID string   `json:"uuid"`
...
func InterfaceToDomain(iData interface{}) *Domain {
	...
	return &Domain{
		...
		//{"Title":"","Description":"Domain level quota, not currently implemented","SQL":"","Default":null,"Operation":"","Presence":"optional","Type":"object","Permission":null,"Properties":{"project_limit":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"project_limit","Item":null,"GoName":"ProjectLimit","GoType":"int","GoPremitive":true},"security_group_limit":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"security_group_limit","Item":null,"GoName":"SecurityGroupLimit","GoType":"int","GoPremitive":true},"virtual_network_limit":{"Title":"","Description":"","SQL":"int","Default":null,"Operation":"","Presence":"optional","Type":"integer","Permission":null,"Properties":{},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"","CollectionType":"","Column":"virtual_network_limit","Item":null,"GoName":"VirtualNetworkLimit","GoType":"int","GoPremitive":true}},"Enum":null,"Minimum":null,"Maximum":null,"Ref":"types.json#/definitions/DomainLimitsType","CollectionType":"","Column":"","Item":null,"GoName":"DomainLimits","GoType":"DomainLimitsType","GoPremitive":false}
