...
func (i *privateInstance) fillPortDetails(log *logrus.Entry, ports []*models.Port) error {
	...
	if err := validateOnPremResourceUniqueness("Ports", len(ports), log); err != nil {
		return err
	}
...
func (i *privateInstance) fillCredentialDetails(
	...
	if err := validateOnPremResourceUniqueness("Credentials", len(credentialRefs), log); err != nil {
		return err
	}
...
func (i *privateInstance) fillGWDetails(
	...
	return i.fillSubNetDetails(ctx, cli, log, subnets)
}
