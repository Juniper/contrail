...
var server *apisrv.APIServer

func TestMain(m *testing.M) {
	apisrv.TestMain(m, &server)
}
...
func runCloudTest(t *testing.T, expectedTopology, expectedSecret string,
	...
	cleanup := apisrv.RunDirtyTestScenario(t, &cloudTestScenario, server)
	...
	_ = apisrv.RunDirtyTestScenario(t, &cloudUpdateTestScenario, server)
	...
	_ = apisrv.RunDirtyTestScenario(t, &cloudDeleteTestScenario, server)
