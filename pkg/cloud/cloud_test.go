	...
	for _, providerConfig := range []*providerConfig{
			...
			filesToCopy: []*fileToCopy{
				{
					...
					destination: getExpectedSSHPrivKeyDestination("cloud_uuid_aws"),
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: getExpectedSSHPubKeyDestination("cloud_uuid_aws"),
				},
				{
		...
		},
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: getExpectedSSHPrivKeyDestination("cloud_uuid_gcp"),
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: getExpectedSSHPubKeyDestination("cloud_uuid_gcp"),
				},
			},
		...
		},
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: getExpectedSSHPrivKeyDestination("cloud_uuid_azure"),
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: getExpectedSSHPubKeyDestination("cloud_uuid_azure"),
				},
			},
...
func applyDBRequests(
	...
	return cleanup, usedScenarios, nil
}
	...
	for _, providerConfig := range []*providerConfig{
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: getExpectedSSHPrivKeyDestination("cloud_uuid_onprem"),
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: getExpectedSSHPubKeyDestination("cloud_uuid_onprem"),
				},
			},
			requestsToStartWith: []string{
...
func verifyGeneratedSSHKeyFiles(t *testing.T, cloudUUID string) {
	...
	expectedPvtKeyPath := getExpectedSSHPrivKeyDestination(cloudUUID)
	expectedPubKeyPath := getExpectedSSHPubKeyDestination(cloudUUID)
...
func getExpectedSSHPrivKeyDestination(cloudUUID string) string {
	return path.Join(GetCloudDir(cloudUUID), "cloud_keypair")
}

func getExpectedSSHPubKeyDestination(cloudUUID string) string {
