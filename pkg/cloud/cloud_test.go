...
const (
	...
	expectedAZCmdForCreateUpdate = "./test_data/expected_cmd_for_create_update.yml"
	expectedAZTopology           = "./test_data/expected_az_cloud_topo.yaml"
	expectedAZSecret             = "./test_data/expected_az_cloud_secret.yaml"
	cloudID                      = "cloud_uuid"
)
...
func runAllInOneCloudTest(t *testing.T, cloudType string) {
	...
	case azure:
		runCloudTest(t, expectedAZTopology, expectedAZSecret,
			expectedAZCmdForCreateUpdate, context, cloudType)
	}
}
...
func executedCommandsPath() string {
	return defaultWorkRoot + "/" + cloudID + "/executed_cloud_cmd.yml"
}
