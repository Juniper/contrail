...
func prepareForTest(
	t *testing.T, dbRequestsFile string, hostFiles []*fileToCopy, cloudUUID string,
	...
	for _, providerConfig := range []*providerConfig{
		{
			...
			requestsToStartWith:  "./test_data/aws/test_aws_create/requests.yml",
		...
		},
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_create/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_create/cloud_keypair.pub",
				},
			},
			requestsToStartWith:  "./test_data/gcp/test_gcp_create/requests.yml",
		...
		},
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_azure_create/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_azure_create/cloud_keypair.pub",
				},
			},
			requestsToStartWith:  "./test_data/azure/test_azure_create/requests.yml",
		...
		},
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_aws_update/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_aws_update/cloud_keypair.pub",
				},
				{
					source:      "./test_data/test_aws_update/topology_before_update.yml",
					destination: "/var/tmp/cloud/cloud_uuid_aws_update/topology.yml",
				},
				{
					source:      "./test_data/test_aws_create/aws_access.key",
					destination: "/var/tmp/contrail/aws_access.key",
				},
				{
					source:      "./test_data/test_aws_create/aws_secret.key",
					destination: "/var/tmp/contrail/aws_secret.key",
				},
			},
		...
		},
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_update/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_update/cloud_keypair.pub",
				},
				{
					source:      "./test_data/test_gcp_update/topology_before_update.yml",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_update/topology.yml",
				},
			},
		...
		},
		{
			...
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_azure_update/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_azure_update/cloud_keypair.pub",
				},
				{
					source:      "./test_data/test_azure_update/topology_before_update.yml",
					destination: "/var/tmp/cloud/cloud_uuid_azure_update/topology.yml",
				},
			},
...
func TestDeletingPublicClouds(t *testing.T) {
	for _, providerConfig := range []*providerConfig{
		{
			providerName: "AWS",
			cloudUUID:    "cloud_uuid_aws_delete",
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_aws_delete/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_aws_delete/cloud_keypair.pub",
				},
				{
					source:      "./test_data/test_aws_delete/topology_before_delete.yml",
					destination: "/var/tmp/cloud/cloud_uuid_aws_delete/topology.yml",
				},
				{
					source:      "./test_data/test_aws_delete/aws_access.key",
					destination: "/var/tmp/contrail/aws_access.key",
				},
				{
					source:      "./test_data/test_aws_delete/aws_secret.key",
					destination: "/var/tmp/contrail/aws_secret.key",
				},
			},
			requestsToStartWith:  "./test_data/test_aws_delete/requests.yml",
			expectedTopologyFile: "./test_data/test_aws_delete/expected_topology.yml",
			expectedSecretFile:   "./test_data/test_aws_delete/expected_secret.yml",
			expectedCommands:     "./test_data/test_aws_delete/expected_commands.yml",
		},
		{
			providerName: "GCP",
			cloudUUID:    "cloud_uuid_gcp_delete",
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_delete/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_delete/cloud_keypair.pub",
				},
				{
					source:      "./test_data/test_gcp_delete/topology_before_delete.yml",
					destination: "/var/tmp/cloud/cloud_uuid_gcp_delete/topology.yml",
				},
			},
			requestsToStartWith:  "./test_data/test_gcp_delete/requests.yml",
			expectedTopologyFile: "./test_data/test_gcp_delete/expected_topology.yml",
			expectedSecretFile:   "./test_data/test_gcp_delete/expected_secret.yml",
			expectedCommands:     "./test_data/test_gcp_delete/expected_commands.yml",
		},
		{
			providerName: "Azure",
			cloudUUID:    "cloud_uuid_azure_delete",
			filesToCopy: []*fileToCopy{
				{
					source:      "./test_data/cloud_keypair",
					destination: "/var/tmp/cloud/cloud_uuid_azure_delete/cloud_keypair",
				},
				{
					source:      "./test_data/cloud_keypair.pub",
					destination: "/var/tmp/cloud/cloud_uuid_azure_delete/cloud_keypair.pub",
				},
				{
					source:      "./test_data/test_azure_delete/topology_before_delete.yml",
					destination: "/var/tmp/cloud/cloud_uuid_azure_delete/topology.yml",
				},
			},
			requestsToStartWith:  "./test_data/test_azure_delete/requests.yml",
			expectedTopologyFile: "./test_data/test_azure_delete/expected_topology.yml",
			expectedSecretFile:   "./test_data/test_azure_delete/expected_secret.yml",
			expectedCommands:     "./test_data/test_azure_delete/expected_commands.yml",
		},
	} {
...
func TestOnPremcreate(t *testing.T, providerConfig) {
	for _, providerConfig := range []*providerConfig{
		{
			providerName: "AWS",
			cloudUUID:    "cloud_uuid_aws_delete",
