...
// DeployerWithDryRun is factory function for option which dry run deployer(log deployer command instead of executing it)
...
func NewDeployer(config DeployerConfig, executor CommandExecutor, reporter *report.Reporter, opts ...DeployerOption) Deployer {
