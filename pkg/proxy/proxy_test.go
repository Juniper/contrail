...
func testHTTPSupport(t *testing.T, synchronizeProxyEndpoints func(s *integration.APIServer)) {
	// arrange
...
func TestRetriesRequestWhenTargetServerIsClosed(t *testing.T) {
	// arrange
...
func TestRetriesRequestWhenTargetServerReturnsServerError(t *testing.T) {
	// arrange
	const (
...
func TestInjectsServiceToken(t *testing.T) {
	// arrange
	const (
...
func TestServiceWebSocketsSupport(t *testing.T) {
	// arrange
	clusterName := contrailClusterName(t, "")
