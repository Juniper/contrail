...
func newPostgresReplicationConnection(db dbService, replConn pgxReplicationConn) (*postgresReplicationConnection,
	error) {
...
func (c *postgresReplicationConnection) DumpSnapshot(ctx context.Context, ow db.ObjectWriter,
