...
func (s *Service) HandleCreate(ctx context.Context, schemaID string, pk string, data map[string]interface{}) error {
...
func (s *Service) HandleUpdate(ctx context.Context, schemaID string, pk string, data map[string]interface{}) error {
...
func (s *Service) HandleDelete(ctx context.Context, schemaID string, pk string) error {
	if err := s.handle(ctx, HandleRequest{SchemaID: schemaID, PK: pk}, deleteFunctions); err != nil {
