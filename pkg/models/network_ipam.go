...
// IpamSubnetSetsSubtract subtracts right set from left set and returns the result
func IpamSubnetSetsSubtract(leftSet []*IpamSubnetType, rightSet []*IpamSubnetType) []*IpamSubnetType {
