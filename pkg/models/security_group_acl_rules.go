...
func allAddressCombinations(rs []*PolicyRuleType) (pairs []addressTypePair) {
	for _, r := range rs {
...
func makeACLRule(pair addressTypePair, fqNameToSG map[string]*SecurityGroup) (*AclRuleType, error) {
