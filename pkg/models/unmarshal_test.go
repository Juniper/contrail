...
// with ApplyMap. CPU performance looks similiar, but allocation load is in favor
// of simple option.
//
...
const testResource string = `{
  ...
  "physical_router_backrefs": [],
  "virtual_machine_interface_backrefs": [],
  "virtual_network_backrefs": [],
  "fabric_backrefs": [],
  "firewall_rule_backrefs": [],
  "instance_ip_backrefs": [],
  "logical_router_backrefs": [],
